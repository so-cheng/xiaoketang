...
namespace WebProject.Areas._2.ZbManage.Controllers
{
    ...
    public class TargetController : BaseLoginController
    {
        ...
        /// </summary>
        [HttpGet]
        public ActionResult DayPost(PageFactory.ZbStandardPost.DtoReq req)
        {
            var pageModel = new PageFactory.ZbStandardPost().Get(req);
            return View(pageModel);
        }
        ...
        /// </summary>
        [HttpGet]
        public ActionResult DayList(PageFactory.ZbStandardList.DtoReq req)
        {
            var pageModel = new PageFactory.ZbStandardList().Get(req);
            return View(pageModel);
        }
    }
}