...
!function (d) {
    "use strict";
    var t, h = d.document, p = function (t) {
        return new r(t)
    }, r = function (t) {
        var n = this
    ...
    Array.prototype.indexOf = Array.prototype.indexOf || function (n, i) {
        ...
        ,
        p.ie = (t = navigator.userAgent.toLowerCase(),
            !!(d.ActiveXObject || "ActiveXObject" in d) && ((t.match(/msie\s(\d+)/) || [])[1] || "11")),
        p.layui = layui || {},
        ...
        p.style = function (t) {
            ...
            if (n)
                return "styleSheet" in e ? (e.setAttribute("type", "text/css"),
                    ...
                    e.id = "LAY-STYLE-" + (t.id || (n = p.style.index || 0,
                        p.style.index++,
                        "DF-" + n)),
                    i && ((t = p(i).find("#" + e.id))[0] && t.remove(),
                        p(i).append(e)),
                    e
        }
        ,
        p.position = function (t, e, n) {
            ...
            e && (n = n || {},
                ...
                l = i.left,
                a = i.bottom,
                "center" === n.align ? l -= (u - t.offsetWidth) / 2 : "right" === n.align && (l = l - u + t.offsetWidth),
                ...
                p.hasScrollbar() || (l = e.getBoundingClientRect(),
                    !n.SYSTEM_RELOAD && l.bottom + c > o() && (n.SYSTEM_RELOAD = !0,
                        setTimeout(function () {
                            p.position(t, e, n)
                        }, 50))))
        }
            ...
            c && p.touchEventsSupported() && (n = {
                ...
                e = function (t) {
                    1 === t.touches.length && (c.addEventListener("touchmove", i, !!p.passiveSupported && {
                        ...
                        n.direction = "none",
                        o.onTouchStart) && o.onTouchStart(t, n)
                }
                ,
                i = function (t) {
                    t.preventDefault(),
                ...
                r = function (t) {
                    o.onTouchEnd && o.onTouchEnd(t, n),
                        ...
                        c.removeEventListener("touchend", r, !!p.passiveSupported && {
                            passive: !1
                        }),
        ...
        p.onClickOutside = function (r, o, t) {
            var e, n, i, c, a = (t = t || {}).event || ("onpointerdown" in d ? "pointerdown" : "mousedown"), u = t.scope || h, s = t.ignore || [], t = !("capture" in t) || t.capture;
            return e = u,
                n = a,
                i = function (t) {
                    var e = r
                        ...
                        for (var n = t.target || t.srcElement, i = 0; i < s.length; i++) {
                            ...
                            if ("string" == typeof r)
                                for (var o = h.querySelectorAll(r), c = 0; c < o.length; c++) {
                                    var a = o[i];
                                    if (a === n || -1 !== e.indexOf(a))
                                        return 1
                                }
                            else if (r && (r === n || -1 !== e.indexOf(r)))
                                return 1
                        }
                    }(t, i) && o(t)
                }
        ...
        ,
        d.lay = p,
        d.layui && layui.define && layui.define(function (t) {
            t("lay", p)
        })
            ...
            t.prototype.view = function () {
                var i, e, t, n = this.config, r = n.groups = "groups" in n ? Number(n.groups) || 0 : 5, u = (n.layout = "object" == typeof n.layout ? n.layout : ["prev", "page", "next"],
                    ...
                    n.pages > r ? Math.ceil((n.curr + (1 < r ? 1 : 0)) / (0 < r ? r : 1)) : 1), l = {
                        ...
                        limit: (i = ['<span class="layui-laypage-limits"><select lay-ignore>'],
                            layui.each(n.limits, function (e, a) {
                                var t;
                                i.push('<option value="' + a + '"' + (a === n.limit ? " selected" : "") + ">" + (t = (a = a) + " \u6761/\u9875",
                                    "function" == typeof n.limitTemplet && n.limitTemplet(a) || t) + "</option>")
                            }),
                            i.join("") + "</select></span>"),
...
!function (i, D) {
    ...
    var n = i.layui && layui.define
        ...
        , k = function (e) {
            var t, a = this, n = (a.index = ++T.index,
    ...
    s.formatArr = function (e) {
        ...
        k.prototype.init = function () {
            ...
            o.elem = lay(o.elem),
                ...
                o.elem[0] && ("array" !== layui.type(o.theme) && (o.theme = [o.theme]),
                    ...
                    (o.show || e) && r.render(),
                    e || r.events(),
                    "function" == typeof o.formatToDisplay && (r.isInput(o.elem[0]) ? r.formatToDisplay(o.elem[0], o.formatToDisplay) : (t = r.rangeElem) && (r.formatToDisplay(t[0][0], o.formatToDisplay),
        ...
        k.prototype.render = function () {
            var a, n, i, l, r = this, o = r.config, d = r.lang(), s = "static" === o.position, y = r.elem = lay.elem("div", {
                id: r.elemID,
                "class": ["layui-laydate", o.range ? " layui-laydate-range" : "", r.rangeLinked ? " layui-laydate-linkage" : "", s ? " " + v : "", o.fullPanel ? " laydate-theme-fullpanel" : "", (a = "",
                    lay.each(o.theme, function (e, t) {
                        "default" === t || /^#/.test(t) || (a += " laydate-theme-" + t)
                    }),
                    a)].join("")
            }), m = r.elemMain = [], u = r.elemHeader = [], c = r.elemCont = [], h = r.table = [], e = r.footer = lay.elem("div", {
                "class": "layui-laydate-footer"
            }), t = r.shortcut = lay.elem("ul", {
                "class": "layui-laydate-shortcut"
            }), p = (o.zIndex && (y.style.zIndex = o.zIndex),
                ...
                lay(e).html((p = [],
                    ...
                    (o.range || "datetime" !== o.type || o.fullPanel) && p.push('<span class="' + x + '" title="' + d.preview + '"></span>'),
                        ...
                        i.join(""))).find("li").on("click", function (e) {
                            var t = o.shortcuts[this.dataset.index] || {}
                                ...
                                , t = (lay.each(t, function (e, t) {
                                    ...
                                    lay(r.footer).find("." + I).removeClass(C));
        ...
        k.prototype.checkDate = function (e) {
            ...
            return "limit" === e ? s.range ? (u(d.rangeLinked ? d.startDate : r),
                d.endDate && u(d.endDate)) : u(r) : ("string" == typeof (m = m || s.value) && (m = m.replace(/\s+/g, " ").replace(/^\s|\s$/g, "")),
                    (a = function () {
                        var e, t, a;
                    ...
                    "string" == typeof m && m ? d.EXP_IF.test(m) ? s.range ? (m = m.split(" " + d.rangeStr + " "),
                        lay.each([s.dateTime, d.endDate], function (e, t) {
                            c(t, m[e], e)
                        })) : c(r, m) : (d.hint(l.formatError[0] + (s.range ? s.format + " " + d.rangeStr + " " + s.format : s.format) + l.formatError[1]),
        ...
        k.prototype.mark = function (t, a) {
            ...
            return e.calendar && "cn" === e.lang && i(n.markerOfChineseFestivals),
                "function" == typeof e.mark ? e.mark({
                    year: a[0],
                    month: a[1],
                    date: a[2]
                }, i) : "object" == typeof e.mark && i(e.mark),
                n
        }
        ,
        ...
        k.prototype.holidays = function (t, a) {
            ...
            return "function" == typeof e.holidays ? e.holidays({
                ...
                month: a[1],
                date: a[2]
            }, i) : "array" === layui.type(e.holidays) && i(e.holidays),
                n
        }
        ,
        ...
        k.prototype.startOfYear = function (e) {
            e = new Date(e);
            return e.setFullYear(e.getFullYear(), 0, 1),
                e.setHours(0, 0, 0, 0),
                e
        }
        ,
        ...
        k.prototype.addDays = function (e, t) {
            e = new Date(e);
            return t && e.setDate(e.getDate() + t),
                e
        }
        ,
        ...
        k.prototype.isDisabledDate = function (e, t) {
            ...
            return !!a.disabledDate && "time" !== a.type && ("date" === t.disabledType || "datetime" === t.disabledType) && ((e = new Date(e)).setHours(0, 0, 0, 0),
                "year" === t.type || "month" === t.type ? this.isDisabledYearOrMonth(e, t.type, n) : a.disabledDate.call(a, e, n))
        }
        ,
        k.prototype.isDisabledTime = function (e, t) {
            t = t || {};
            var a, n = this.config, i = !n.range || 0 === t.rangeType ? "start" : "end";
            return !!n.disabledTime && !("time" !== n.type && "datetime" !== n.type || "time" !== t.disabledType && "datetime" !== t.disabledType) && (a = function (e, t, a) {
                ...
                "datetime" === t.disabledType ? a(e.hours, i.hours)() || a(e.minutes, i.minutes, [e.hours])() || a(e.seconds, i.seconds, [e.hours, e.minutes])() : [a(e.hours, i.hours), a(e.minutes, i.minutes, [e.hours]), a(e.seconds, i.seconds, [e.hours, e.minutes])][t.time.length - 1]())
        }
        ,
        ...
        k.prototype.calendar = function (e, i, t) {
            i = i ? 1 : 0;
            var l, r, o, d = this, a = d.config, s = e || d.thisDateTime(i), n = new Date, y = d.lang(), m = "date" !== a.type && "datetime" !== a.type, u = lay(d.table[i]).find("td"), c = lay(d.elemHeader[i][2]).find("span");
            return s.year < h[0] && (s.year = h[0],
                d.hint(y.invalidDate)),
                ...
                lay.each(u, function (e, t) {
                    ...
                    (t = lay(t)).removeAttr("class"),
                        e < l ? (a = r - l + e,
                            ...
                            n = d.getAsYM(s.year, s.month, "sub")) : l <= e && e < o + l ? (a = e - l,
                                d.rangeLinked || a + 1 === s.date && t.addClass(M)) : (a = e - o - l,
                                    t.addClass("laydate-day-next"),
                                    n = d.getAsYM(s.year, s.month)),
                        n[1]++,
                        n[2] = a + 1,
                        t.attr("lay-ymd", n.join("-")).html("<div>" + n[2] + "</div>"),
                        d.mark(t, n).holidays(t, n).limit({
                            elem: t,
                            date: {
                                year: n[0],
                                month: n[1] - 1,
                ...
                "cn" === a.lang ? (lay(c[0]).attr("lay-type", "year").html(s.year + " \u5e74"),
                    lay(c[1]).attr("lay-type", "month").html(s.month + 1 + " \u6708")) : (lay(c[0]).attr("lay-type", "month").html(y.month[s.month]),
                        lay(c[1]).attr("lay-type", "year").html(s.year)),
                m && (a.range ? !e && "init" === t || (d.listYM = [[(d.startDate || a.dateTime).year, (d.startDate || a.dateTime).month + 1], [d.endDate.year, d.endDate.month + 1]],
                    d.list(a.type, 0).list(a.type, 1),
                    "time" === a.type ? d.setBtnStatus("\u65f6\u95f4", lay.extend({}, d.systemDate(), d.startTime), lay.extend({}, d.systemDate(), d.endTime)) : d.setBtnStatus(!0)) : (d.listYM = [[s.year, s.month + 1]],
                        d.list(a.type, 0))),
                a.range && "init" === t && (d.rangeLinked ? (n = d.getAsYM(s.year, s.month, i ? "sub" : null),
                    d.calendar(lay.extend({}, s, {
                        year: n[0],
                        month: n[1]
                    }), 1 - i)) : d.calendar(null, 1 - i)),
                a.range || (u = ["hours", "minutes", "seconds"],
                    d.limit({
                ...
                d.setBtnStatus(),
                lay(d.shortcut).find("li." + M).removeClass(M),
                a.range && !m && "init" !== t && d.stampRange(),
                d
        }
        ,
        k.prototype.list = function (n, i) {
            var l, r, e, a, o, d, t, s = this, y = s.config, m = s.rangeLinked ? y.dateTime : [y.dateTime, s.endDate][i], u = s.lang(), c = y.range && "date" !== y.type && "datetime" !== y.type, h = lay.elem("ul", {
                "class": b + " " + {
                    year: "laydate-year-list",
                    month: "laydate-month-list",
                    time: "laydate-time-list"
                }[n]
            }), p = s.elemHeader[i], f = lay(p[2]).find("span"), g = s.elemCont[i || 0], D = lay(g).find("." + b)[0], T = "cn" === y.lang, v = T ? "\u5e74" : "", x = s.listYM[i] || {}, w = ["hours", "minutes", "seconds"], k = ["startTime", "endTime"][i];
            return x[0] < 1 && (x[0] = 1),
                "year" === n ? (e = l = x[0] - 7,
                    l < 1 && (e = l = 1),
                    ...
                    lay(f[T ? 0 : 1]).attr("lay-ym", l - 8 + "-" + x[1]).html(e + v + " - " + (l - 1) + v)) : "month" === n ? (lay.each(new Array(12), function (e) {
                        ...
                        lay(f[T ? 0 : 1]).attr("lay-ym", x[0] + "-" + x[1]).html(x[0] + v)) : "time" === n && (r = function () {
                            ...
                            lay.each([e, f, t], function (e, t) {
                                t || (a[e].className += " layui-hide",
                                    o++)
                            }),
                            h.className += " laydate-time-list-hide-" + o),
                D && g.removeChild(D),
                g.appendChild(h),
                "year" === n || "month" === n ? (lay(s.elemMain[i]).addClass("laydate-ym-show"),
                    lay(h).find("li").on("click", function () {
                        var e = 0 | lay(this).attr("lay-ym");
                        lay(this).hasClass(C) || (s.rangeLinked ? lay.extend(m, {
                            year: "year" === n ? e : x[0],
                            month: "year" === n ? x[1] - 1 : e
                        }) : m[n] = e,
                            "year" === y.type || "month" === y.type ? (lay(h).find("." + M).removeClass(M),
                                lay(this).addClass(M),
                                "month" === y.type && "year" === n && (s.listYM[i][0] = e,
                                    c && ((i ? s.endDate : m).year = e),
                                    s.list("month", i))) : (s.checkDate("limit").calendar(m, i, "init"),
                                        s.closeList()),
                            s.setBtnStatus(),
                            !y.range && y.autoConfirm && ("month" === y.type && "month" === n || "year" === y.type && "year" === n) && s.setValue(s.parse()).done().remove(),
                            s.autoCalendarModel.auto && !s.rangeLinked ? s.choose(lay(g).find("td.layui-this"), i) : s.endState && s.done(null, "change"),
                            lay(s.footer).find("." + I).removeClass(C))
                    })) : (f = lay.elem("span", {
                        "class": L
                    }),
                        d = function () {
                        ...
                        (D = lay(h).find("ol")).each(function (t) {
                            ...
                            lay(a).find("li").on("click", function () {
                                ...
                                lay(this).hasClass(C) || (y.range ? s[k][w[t]] = e : m[w[t]] = e,
                                    lay(a).find("." + M).removeClass(M),
                                    lay(this).addClass(M),
                                    r(),
                                    d(),
                                    !s.endDate && "time" !== y.type && "datetime" !== y.type || s.done(null, "change"),
                                    s.setBtnStatus())
                            })
                        }),
        ...
        k.prototype.setBtnStatus = function (e, t, a) {
            ...
            i.range && (t = t || (n.rangeLinked ? n.startDate : i.dateTime),
                a = a || n.endDate,
                ...
                n.limit({
                    ...
                    time: o,
                    rangeType: 1
                }) ? r.addClass(C) : r[i ? "addClass" : "removeClass"](C),
        ...
        k.prototype.formatToDisplay = function (e, t) {
            ...
            Object.defineProperty(e, "value", lay.extend({}, n, {
                ...
                set: function (e) {
                    n.set.call(this, t.call(a, e)),
                        this.setAttribute("lay-date", e)
                }
            }))
        }
        ,
        k.prototype.setValue = function (e) {
            var t, a = this, n = a.config, i = n.elem[0];
            return "static" !== n.position && (e = e || "",
                a.isInput(i) ? lay(i).val(e) : (t = a.rangeElem) ? ("array" !== layui.type(e) && (e = e.split(" " + a.rangeStr + " ")),
                    t[0].val(e[0] || ""),
                    t[1].val(e[1] || "")) : (0 === lay(i).find("*").length && (t = "function" == typeof n.formatToDisplay ? n.formatToDisplay(e) : e,
                        lay(i).html(t)),
        ...
        k.prototype.preview = function () {
            ...
            a.isPreview && (e = lay(t.elem).find("." + x),
        ...
        k.prototype.choose = function (e, a) {
            ...
            e.hasClass(C) || (i = (n = this).config,
                ...
                i.range ? (lay.each(["startTime", "endTime"], function (e, t) {
                    ...
                    n.rangeLinked ? (e = n.checkPanelDate(l, t),
                        o = lay.extend({}, l),
                        d = r || e && e.needFullRender ? "init" : null,
                        e = e ? e.index : t,
                        n.calendar(o, e, d)) : n.calendar(null, a, r ? "init" : null),
        ...
        k.prototype.tool = function (t, e) {
            var a = this
                ...
                , o = {
                    datetime: function () {
                        lay(t).hasClass(C) || (a.list("time", 0),
                    ...
                    confirm: function () {
                        if (n.range) {
                            if (lay(t).hasClass(C))
                                return ("time" === n.type ? a.startTime && a.endTime && a.newDate(a.startTime) > a.newDate(a.endTime) : a.startDate && a.endDate && a.newDate(lay.extend({}, a.startDate, a.startTime || {})) > a.newDate(lay.extend({}, a.endDate, a.endTime || {}))) ? a.hint("time" === n.type ? i.timeout.replace(/\u65e5\u671f/g, "\u65f6\u95f4") : i.timeout) : a.hint(i.invalidDate)
                        } else if (lay(t).hasClass(C))
        ...
        k.prototype.change = function (n) {
            ...
            return {
                ...
                prevMonth: function () {
                    var e, t;
                    i.rangeLinked ? (t = i.panelYM[0],
                        t = i.getAsYM(t.year, t.month, "sub"),
                        e = lay.extend({}, l.dateTime, i.panelYM[0], {
                            year: t[0],
                            month: t[1]
                        }),
                        i.checkDate("limit").calendar(e, null, "init")) : (t = i.getAsYM(r.year, r.month, "sub"),
                            lay.extend(r, {
                                year: t[0],
                                month: t[1]
                            }),
                    ...
                    lay(e[0]).on("click", function (e) {
                        ...
                        lay(e[2]).find("span").on("click", function (e) {
                            ...
                            a && (a = a.split("-"),
                                ...
                                i.list(t, n),
                                lay(i.footer).find("." + I).addClass(C))
                        }),
        ...
        l.run = function (n) {
            n(D).on("mousedown", function (e) {
                var t, a;
                T.thisId && (t = s.getThis(T.thisId)) && (a = t.config,
                    e.target === a.elem[0] || e.target === a.eventElem[0] || e.target === n(a.closeStop)[0] || a.elem[0] && a.elem[0].contains(e.target) || t.remove())
            }).on("keydown", function (e) {
                var t;
                T.thisId && (t = s.getThis(T.thisId)) && "static" !== t.config.position && 13 === e.keyCode && n("#" + t.elemID)[0] && t.elemID === k.thisElemDate && (e.preventDefault(),
...
!function (p, m) {
    "use strict";
    var h, g, e, n = p.layui && layui.define, f = {
        ...
        link: function (e, i, t) {
            var n, a, o, s, r, l;
            v.path && (n = document.getElementsByTagName("head")[0],
                ...
                "function" == typeof i) && !function c(e) {
                    ...
                    return 100 < ++l ? p.console && console.error(o + ".css: Invalid") : void (1989 === parseInt(f.getStyle(t, "width")) ? (e === r && t.removeAttribute("lay-status"),
                        t.getAttribute("lay-status") === r ? setTimeout(c, 100) : i()) : (t.setAttribute("lay-status", r),
                            setTimeout(function () {
                                c(r)
                            }, 100)))
                }()
        ...
        path: f.getPath,
        config: function (e, t) {
            return v.cache = f.config = h.extend({}, f.config, e = e || {}),
        ...
        ready: function (e) {
            ...
            return n ? layui["layui.all"] ? "function" == typeof e && e() : layui.addcss(i, e, t) : f.link(i, e, t),
                this
        },
        ...
        msg: function (e, t, i) {
            ...
            return n && (i = t),
                v.open(h.extend({
                    ...
                    anim: o
                } : (-1 !== (t = t || {}).icon && (t.icon !== m || f.config.skin) || (t.skin = a + " " + (t.skin || "layui-layer-hui")),
                    t)))
        },
        load: function (e, t) {
            return v.open(h.extend({
        ...
        ["layui-layer", ".layui-layer-title", ".layui-layer-main", ".layui-layer-dialog", "layui-layer-iframe", "layui-layer-content", "layui-layer-btn", "layui-layer-close"]), y = (u.anim = {
            0: "layer-anim-00",
            1: "layer-anim-01",
            2: "layer-anim-02",
            3: "layer-anim-03",
            ...
            "LAYUI-LAYER-SHADE-KEY"), l = "LAYUI_LAYER_CONTENT_RECORD_HEIGHT", i = (t.pt.config = {
                type: 0,
                shade: .3,
                fixed: !0,
                move: u[1],
                ...
                t.pt.vessel = function (e, t) {
                    var i, n = this.index, a = this.config, o = a.zIndex + n, s = "object" == typeof a.title, r = a.maxmin && (1 === a.type || 2 === a.type), s = a.title ? '<div class="layui-layer-title" style="' + (s ? a.title[1] : "") + '">' + (s ? a.title[0] : a.title) + "</div>" : "";
                    return a.zIndex = o,
                        t([a.shade ? '<div class="' + u.SHADE + '" id="' + u.SHADE + n + '" times="' + n + '" style="z-index:' + (o - 1) + '; "></div>' : "", '<div class="' + u[0] + " layui-layer-" + f.type[a.type] + (0 != a.type && 2 != a.type || a.shade ? "" : " layui-layer-border") + " " + (a.skin || "") + '" id="' + u[0] + n + '" type="' + f.type[a.type] + '" times="' + n + '" showtime="' + a.time + '" conType="' + (e ? "object" : "string") + '" style="z-index: ' + o + "; width:" + a.area[0] + ";height:" + a.area[1] + ";position:" + (a.fixed ? "fixed;" : "absolute;") + '">' + (e && 2 != a.type ? "" : s) + "<div" + (a.id ? ' id="' + a.id + '"' : "") + ' class="layui-layer-content' + (0 == a.type && -1 !== a.icon ? " layui-layer-padding" : "") + (3 == a.type ? " layui-layer-loading" + a.icon : "") + '">' + (n = ["layui-icon-tips", "layui-icon-success", "layui-icon-error", "layui-icon-question", "layui-icon-lock", "layui-icon-face-cry", "layui-icon-face-smile"],
                            ...
                            0 == a.type && -1 !== a.icon ? '<i class="layui-layer-face layui-icon ' + ((i = 16 == a.icon ? "layui-icon layui-icon-loading " + o : i) || n[a.icon] || n[0]) + '"></i>' : 3 == a.type ? (i = ["layui-icon-loading", "layui-icon-loading-1"],
                                2 == a.icon ? '<div class="layui-layer-loading-2 ' + o + '"></div>' : '<i class="layui-layer-loading-icon layui-icon ' + (i[a.icon] || i[0]) + " " + o + '"></i>') : "") + ((1 != a.type || !e) && a.content || "") + '</div><div class="layui-layer-setwin">' + (n = [],
                                    r && (n.push('<span class="layui-layer-min"></span>'),
                                    ...
                                    n.join("")) + "</div>" + (a.btn ? function () {
                                        ...
                                        return '<div class="' + (t = [u[6]],
                                            ...
                                            t.join(" ")) + '">' + e + "</div>"
                                    }() : "") + (a.resize ? '<span class="layui-layer-resize"></span>' : "") + "</div>"], s, h('<div class="' + u.MOVE + '" id="' + u.MOVE + '"></div>')),
                        this
                }
                ,
                t.pt.creat = function () {
                    var e, t, i, n, a = this, o = a.config, s = a.index, r = "object" == typeof (d = o.content), l = h("body"), c = function (e) {
                        var t;
                        o.shift && (o.anim = o.shift),
                            u.anim[o.anim] && (t = "layer-anim " + u.anim[o.anim],
                    ...
                    if (o.id && h("." + u[0]).find("#" + o.id)[0])
                        e = h("#" + o.id).closest("." + u[0]),
                            ...
                            i = e.data("config"),
                            n = h("#" + u.SHADE + t),
                            "min" === (e.data("maxminStatus") || {}) ? v.restore(t) : i.hideOnClose && (n.show(),
                                e.show(),
                                c(e),
                                setTimeout(function () {
                                    n.css({
                        ...
                        switch (o.removeFocus && document.activeElement && document.activeElement.blur(),
                        "string" == typeof o.area && (o.area = "auto" === o.area ? ["", ""] : [o.area, ""]),
                        6 == v.ie && (o.fixed = !1),
                        o.type) {
                            case 0:
                                o.btn = "btn" in o ? o.btn : f.btn[0],
                                    v.closeAll("dialog");
                                break;
                            case 2:
                        ...
                        a.vessel(r, function (e, t, i) {
                            l.append(e[0]),
                                r ? 2 == o.type || 4 == o.type ? h("body").append(e[1]) : d.parents("." + u[0])[0] || (d.data("display", d.css("display")).show().addClass("layui-layer-wrap").wrap(e[1]),
                                    h("#" + u[0] + s).find("." + u[5]).before(t)) : l.append(e[1]),
                            ...
                            4 == o.type ? a.tips() : (a.offset(),
                                parseInt(f.getStyle(document.getElementById(u.MOVE), "z-index")) || (a.layero.css("visibility", "hidden"),
                                    v.ready(function () {
                                        a.offset(),
                                            a.layero.css("visibility", "visible")
                                    }))),
                ...
                t.pt.auto = function (e) {
                    var t = this.config
                        , i = h("#" + u[0] + e)
                        , n = ("" === t.area[0] && 0 < t.maxWidth && (v.ie && v.ie < 8 && t.btn && i.width(i.innerWidth()),
                    ...
                    return 2 === t.type ? e("iframe") : "" === t.area[1] ? 0 < t.maxHeight && i.outerHeight() > t.maxHeight ? (n[1] = t.maxHeight,
                        e("." + u[5])) : t.fixed && n[1] >= g.height() && (n[1] = g.height(),
                            e("." + u[5])) : e("." + u[5]),
                        this
                }
                ,
                t.pt.offset = function () {
                    ...
                    e.offsetTop = (g.height() - n[1]) / 2,
                        ...
                        a ? (e.offsetTop = t.offset[0],
                            e.offsetLeft = t.offset[1] || e.offsetLeft) : "auto" !== t.offset && ("t" === t.offset ? e.offsetTop = 0 : "r" === t.offset ? e.offsetLeft = g.width() - n[0] : "b" === t.offset ? e.offsetTop = g.height() - n[1] : "l" === t.offset ? e.offsetLeft = 0 : "lt" === t.offset ? (e.offsetTop = 0,
                                e.offsetLeft = 0) : "lb" === t.offset ? (e.offsetTop = g.height() - n[1],
                                    e.offsetLeft = 0) : "rt" === t.offset ? (e.offsetTop = 0,
                                        e.offsetLeft = g.width() - n[0]) : "rb" === t.offset ? (e.offsetTop = g.height() - n[1],
                                            e.offsetLeft = g.width() - n[0]) : e.offsetTop = t.offset),
                        t.fixed || (e.offsetTop = /%$/.test(e.offsetTop) ? g.height() * parseFloat(e.offsetTop) / 100 : parseFloat(e.offsetTop),
                            e.offsetLeft = /%$/.test(e.offsetLeft) ? g.width() * parseFloat(e.offsetLeft) / 100 : parseFloat(e.offsetLeft),
                            e.offsetTop += g.scrollTop(),
                            e.offsetLeft += g.scrollLeft()),
                        "min" === i.data("maxminStatus") && (e.offsetTop = g.height() - (i.find(u[1]).outerHeight() || 0),
                ...
                t.pt.tips = function () {
                    ...
                    e.tips[1] || o.remove(),
                        a.autoLeft = function () {
                            0 < a.left + i[0] - g.width() ? (a.tipLeft = a.left + a.width - i[0],
                                o.css({
                                    right: 12,
                                    left: "auto"
                                })) : a.tipLeft = a.left
                        ...
                        a.where[n - 1](),
                        1 === n ? a.top - (g.scrollTop() + i[1] + 16) < 0 && a.where[2]() : 2 === n ? 0 < g.width() - (a.left + a.width + i[0] + 16) || a.where[3]() : 3 === n ? 0 < a.top - g.scrollTop() + a.height + i[1] + 16 - g.height() && a.where[0]() : 4 === n && 0 < i[0] + 16 - a.left && a.where[1](),
                        t.find("." + u[5]).css({
                ...
                t.pt.move = function () {
                    ...
                    return a.move && t.css("cursor", "move"),
                        ...
                        f.docEvent || (e.on("mousemove", function (e) {
                            var t, i, n, a, o, s, r;
                            f.eventMoveElem && (t = (a = f.eventMoveElem.data(l[0]) || {}).layero,
                                o = a.config,
                                ...
                                o.moveOut || (i = g.width() - t.outerWidth() + a.stX,
                            ...
                            var t, i;
                            f.eventMoveElem && (i = (t = f.eventMoveElem.data(l[0]) || {}).config,
                                f.eventMoveElem.removeData(l[0]),
                                delete f.eventMoveElem,
                                f.moveElem.hide(),
                                i.moveEnd) && i.moveEnd(t.layero),
                                f.eventResizeElem && (f.eventResizeElem.removeData(l[1]),
                ...
                t.pt.callback = function () {
                    var n = this
                        ...
                        , o = n.config;
                    n.openLayer(),
                        o.success && (2 == o.type ? a.find("iframe").on("load", function () {
                            o.success(a, n.index, n)
                        }) : o.success(a, n.index, n)),
                        6 == v.ie && n.IE6(a),
                        a.find("." + u[6]).children("a").on("click", function () {
                            var e, t = h(this), i = t.index();
                            t.attr("disabled") || (o.btnAsync ? (e = 0 === i ? o.yes || o.btn1 : o["btn" + (i + 1)],
                        ...
                        a.find(".layui-layer-max").on("click", function () {
                            h(this).hasClass("layui-layer-maxmin") ? (v.restore(n.index),
                                o.restore && o.restore(a, n.index, n)) : (v.full(n.index, o),
                                    setTimeout(function () {
                ...
                t.pt.openLayer = function () {
                    v.zIndex = this.config.zIndex,
                        v.setTop = function (e) {
                            return v.zIndex = parseInt(e[0].style.zIndex),
                                e.on("mousedown", function () {
                                    v.zIndex++,
                                        e.css("z-index", v.zIndex + 1)
                                }),
                                v.zIndex
                        }
                }
                ...
                f.promiseLikeResolve = function (e) {
                    var t = h.Deferred();
                    return e && "function" == typeof e.then ? e.then(t.resolve, t.reject) : t.resolve(e),
                        t.promise()
                }
                ,
                (p.layer = v).getChildFrame = function (e, t) {
                    return t = t || h("." + u[4]).attr("times"),
                        h("#" + u[0] + t).find("iframe").contents().find(e)
                }
                ,
                ...
                v.iframeAuto = function (e) {
                    var t, i, n;
                    e && (t = v.getChildFrame("html", e).outerHeight(),
                ...
                v.style = function (e, t, i) {
                    ...
                    e.attr("minLeft");
                    a !== f.type[3] && a !== f.type[4] && (i || (parseFloat(t.width) <= 260 && (t.width = 260),
                        parseFloat(t.height) - o - s <= 64 && (t.height = 64 + o + s)),
                        e.css(t),
                        s = e.find("." + u[6]).outerHeight() || 0,
                        a === f.type[2] ? e.find("iframe").css({
                ...
                ,
                v.min = function (e, t) {
                    var i, n, a, o, s, r, l = h("#" + u[0] + e), c = l.data("maxminStatus");
                    "min" !== c && ("max" === c && v.restore(e),
                        ...
                        f.record(l),
                        0 < f.minStackArr.length && (o = f.minStackArr[0],
                            f.minStackArr.shift()),
                        parseFloat(o) + 180 > g.width() && (o = g.width() - 180 - (f.minStackArr.edgeIndex = f.minStackArr.edgeIndex || 0,
                            f.minStackArr.edgeIndex += 3)) < 0 && (o = 0),
                        t.minStack && (r.left = o,
                            r.top = g.height() - n,
                            a || f.minStackIndex++,
                            l.attr("minLeft", o)),
                ...
                v.restore = function (e) {
                    ...
                    t.removeData("maxminStatus"),
                        ...
                        r !== m && (n.removeData(l),
                            (o === f.type[2] ? n.children("iframe") : n).css({
                                height: r
                            })),
                        i.show()
                }
                ...
                v.close = function (s, r) {
                    var e, t, l = (e = h("." + u[0]).children("#" + s).closest("." + u[0]))[0] ? (s = e.attr("times"),
                        e) : h("#" + u[0] + s), c = l.attr("type"), i = l.data("config") || {}, d = i.id && i.hideOnClose;
                    l[0] && (t = function () {
                        var o = {
                            ...
                            , e = function () {
                                ...
                                if (d)
                                    return l.removeClass("layer-anim " + o),
                                        l.hide();
                                if (c === f.type[1] && "object" === l.attr("conType")) {
                                    l.children(":not(." + u[5] + ")").remove();
                                    for (var t = l.find("." + e), i = 0; i < 2; i++)
                                        t.unwrap();
                                ...
                                "function" == typeof f.end[s] && f.end[s](),
                                    delete f.end[s],
                                    "function" == typeof r && r(),
                                    f.events.resize[s] && (g.off("resize", f.events.resize[s]),
                        ...
                        v.ie && v.ie < 10 || !i.isOutAnim ? t[d ? "hide" : "remove"]() : (t.css({
                            ...
                            6 == v.ie && f.reselect(),
                            f.restScrollbar(s),
                            "string" == typeof l.attr("minLeft") && (f.minStackIndex--,
                                f.minStackArr.push(l.attr("minLeft"))),
                            v.ie && v.ie < 10 || !i.isOutAnim ? e() : setTimeout(function () {
                                e()
                            }, 200)
                    }
                        ,
                        d || "function" != typeof f.beforeEnd[s] ? (delete f.beforeEnd[s],
                            t()) : f.promiseLikeResolve(f.beforeEnd[s]()).then(function (e) {
                                !1 !== e && (delete f.beforeEnd[s],
                                    t())
                            }, function (e) {
                                e !== m && p.console && p.console.error("layer error hint: " + e)
                            }))
                ...
                v.closeLast = function (i, e) {
                    var t, n = [], a = h.isArray(i);
                    h("string" == typeof i ? ".layui-layer-" + i : ".layui-layer").each(function (e, t) {
                        t = h(t);
                        if (a && -1 === i.indexOf(t.attr("type")) || "none" === t.css("display"))
                            return !0;
                        n.push(Number(t.attr("times")))
                    }),
                        0 < n.length && (t = Math.max.apply(null, n),
                            v.close(t, e))
                }
                ,
                v.cache || {}), x = function (e) {
    ...
    v.prompt = function (i, n) {
        ...
        v.photos = function (n, e, a) {
            ...
            if ((n = h.extend(!0, {
                ...
                var t = o[r].src
                    , f = function (e) {
                        ...
                        a && (n.anim = -1),
                            s.index = v.open(h.extend({
                                ...
                                content: '<div class="layer-layer-photos-main"><img src="' + o[r].src + '" alt="' + i + '" layer-pid="' + (o[r].pid || "") + '">' + (t = ['<div class="layui-layer-photos-pointer">'],
                                    ...
                                    n.footer && t.push(['<div class="layui-layer-photos-toolbar layui-layer-photos-footer">', "<h3>" + i + "</h3>", "<em>" + s.imgIndex + " / " + o.length + "</em>", '<a href="' + o[r].src + '" target="_blank">\u67e5\u770b\u539f\u56fe</a>', "</div>"].join("")),
                                    t.push("</div>"),
                                    t.join("")) + "</div>",
                    ...
                    , y = new Image;
                (y.src = t,
                    y.complete) ? f(y) : (y.onload = function () {
                        y.onload = null,
                            f(y)
                    }
                        ,
        ...
        ,
        p.layui && layui.define ? (v.ready(),
            layui.define(["jquery", "lay"], function (e) {
                v.path = layui.cache.dir,
                    f.run(layui.$),
                    e("layer", p.layer = v)
            })) : "function" == typeof define && define.amd ? define(["jquery"], function () {
                return f.run(p.jQuery),
                    v
            }) : (v.ready(),
                f.run(p.jQuery))
}(window);
...
layui.define(["jquery", "laytpl", "lay", "util"], function (e) {
    "use strict";
    var n, i, t, c = layui.$, m = layui.laytpl, p = layui.util, l = layui.hint(), o = layui.device().mobile ? "touchstart" : "mousedown", r = "dropdown", y = "layui_" + r + "_index", f = "lay-" + r + "-id", h = {
        config: {
            customName: {
                id: "id",
                title: "title",
    ...
    }, v = "layui-dropdown", a = "layui-menu-item-up", d = "layui-menu-item-down", w = "layui-menu-body-title", s = "layui-menu-item-group", V = "layui-menu-item-parent", u = "layui-menu-item-checked", C = "layui-menu-item-checked2", x = "layui-menu-body-panel", b = "layui-menu-body-panel-left", k = "layui-dropdown-shade", T = "." + s + ">." + w, E = function (e) {
        var i = this;
        i.index = ++h.index,
    ...
    E.prototype.config = {
        ...
        E.prototype.init = function (e, i) {
            var t, n = this, l = n.config, a = c(l.elem);
            return 1 < a.length ? (layui.each(a, function () {
                h.render(c.extend({}, l, {
                    elem: this
                }))
            }),
                n) : (c.extend(l, lay.options(a[0])),
                    !e && a[0] && a.attr(f) ? (t = g.getThis(a.attr(f))) ? t.reload(l, i) : void 0 : (l.elem = c(l.elem),
                        l.id = "id" in l ? l.id : a.attr("id") || n.index,
                        a.attr(f, l.id),
                        l.customName = c.extend({}, h.config.customName, l.customName),
                        (l.show || "reloadData" === i && n.elemView && c("body").find(n.elemView.get(0)).length) && n.render(e, i),
                        void n.events()))
        }
        ,
        E.prototype.render = function (e, i) {
            var a = this
                ...
                , n = function () {
                    ...
                    return 0 < d.data.length ? u(e, d.data) : e.html('<li class="layui-menu-item-none">\u6682\u65e0\u6570\u636e</li>'),
                        e
                }
                , u = function (r, e) {
                    return layui.each(e, function (e, i) {
                        var t, n = i[s.children] && 0 < i[s.children].length, l = ("isSpreadItem" in i ? i : d).isSpreadItem, a = (o = p.escape(i[s.title]),
                            a = i.templet || d.templet,
                            o = a ? "function" == typeof a ? a(i) : m(a).render(i) : o), o = (n && (i.type = i.type || "parent"),
                                i.type ? {
                                    group: "group",
                                    parent: "parent",
                                    "-": "-"
                        ...
                        ("-" === o || i[s.title] || i[s.id] || n) && ((a = c(["<li" + (t = {
                            ...
                            n || o ? ' class="' + t[o] + '"' : i.disabled ? ' class="layui-disabled"' : "") + ">", (t = "href" in i ? '<a href="' + i.href + '" target="' + (i.target || "_self") + '">' + a + "</a>" : a,
                                n ? '<div class="' + w + '">' + t + ("parent" === o ? '<i class="layui-icon layui-icon-right"></i>' : "group" === o && d.isAllowSpread ? '<i class="layui-icon layui-icon-' + (l ? "up" : "down") + '"></i>' : "") + "</div>" : '<div class="' + w + '">' + t + "</div>"), "</li>"].join(""))).data("item", i),
                            n && (l = c('<div class="layui-panel layui-menu-body-panel"></div>'),
                                t = c("<ul></ul>"),
                                "parent" === o ? (l.append(u(t, i[s.children])),
                                    a.append(l)) : a.append(u(t, i[s.children]))),
                            r.append(a))
                    }),
                        r
                }
                , l = ['<div class="layui-dropdown layui-border-box layui-panel layui-anim layui-anim-downbit" ' + f + '="' + d.id + '">', "</div>"].join("");
            !(e = "contextmenu" !== d.trigger && !lay.isTopElem(d.elem[0]) ? e : !0) && d.elem.data(y + "_opened") || (a.elemView = c("." + v + "[" + f + '="' + d.id + '"]'),
                "reloadData" === i && a.elemView.length ? a.elemView.html(d.content || n()) : (a.elemView = c(l),
                    ...
                    e = d.shade ? '<div class="' + k + '" style="z-index:' + (a.elemView.css("z-index") - 1) + "; background-color: " + (d.shade[1] || "#000") + "; opacity: " + (d.shade[0] || d.shade) + '"></div>' : "",
                    a.elemView.before(e),
                    "mouseenter" === d.trigger && a.elemView.on("mouseenter", function () {
                ...
                a.elemView.find(".layui-menu li").on("click", function (e) {
                    var i = c(this)
                        ...
                        , l = "all" === d.clickScope;
                    t.disabled || n && !l || "-" === t.type || (!1 === ("function" == typeof d.click ? d.click(t, i) : null) || n || a.remove(),
                        layui.stope(e))
                }),
        ...
        E.prototype.remove = function () {
            ...
            n && (i = n.attr(f),
                ...
                n.remove(),
                delete g.prevElem,
                "function" == typeof t) && t.call(i.config, e),
                lay("." + k).remove()
        }
        ,
        ...
        g.getThis = function (e) {
            var i = g.that[e];
            return i || l.error(e ? r + " instance with ID '" + e + "' not found" : "ID argument required"),
                i
        }
        ,
        g.spread = function (e, i) {
            ...
            t.is(":animated") || (n ? (e.removeClass(a).addClass(d),
                t.hide().stop().slideDown(200, l)) : (t.stop().slideUp(200, l),
                    e.removeClass(d).addClass(a)),
                n && i && ((t = e.siblings("." + d)).children("ul").stop().slideUp(200, l),
        ...
        n.on("resize", function () {
            if (h.thisId) {
                ...
                if (e)
                    return !(e.elemView && !e.elemView[0] || !c("." + v)[0]) && void ("contextmenu" === e.config.trigger ? e.remove() : e.position())
            }
        }),
        i.on(o, function (e) {
            var i, t;
            h.thisId && (i = g.getThis(h.thisId)) && (t = i.config,
        ...
        i.on("mouseenter", t, function (e) {
            var i, t = c(this).find("." + x);
            t[0] && ((i = t[0].getBoundingClientRect()).right > n.width() && (t.addClass(b),
                (i = t[0].getBoundingClientRect()).left < 0) && t.removeClass(b),
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var x = layui.$
        ...
        , m = {
            ...
            set: function (e) {
                var t = this;
                return t.config = x.extend({}, t.config, e),
                    t
            },
            on: function (e, t) {
    ...
    t.prototype.config = {
        ...
        t.prototype.render = function () {
            ...
            var t, e = a.disabled ? "#c2c2c2" : a.theme, i = '<div class="layui-slider ' + ("vertical" === a.type ? "layui-slider-vertical" : "") + '">' + (a.tips ? '<div class="' + L + '" ' + (a.tipsAlways ? "" : 'style="display:none;"') + "></div>" : "") + '<div class="layui-slider-bar" style="background:' + e + "; " + ("vertical" === a.type ? "height" : "width") + ":" + l + ";" + ("vertical" === a.type ? "bottom" : "left") + ":" + (i || 0) + ';"></div><div class="layui-slider-wrap" style="' + ("vertical" === a.type ? "bottom" : "left") + ":" + (i || l) + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + e + ';"></div></div>' + (a.range ? '<div class="layui-slider-wrap" style="' + ("vertical" === a.type ? "bottom" : "left") + ":" + s + ';"><div class="layui-slider-wrap-btn" style="border: 2px solid ' + e + ';"></div></div>' : "") + "</div>", l = x(a.elem), s = l.next(".layui-slider");
            if (s[0] && s.remove(),
                n.elemTemp = x(i),
                a.range ? (n.elemTemp.find("." + w).eq(0).data("value", a.value[0]),
                    n.elemTemp.find("." + w).eq(1).data("value", a.value[1])) : n.elemTemp.find("." + w).data("value", a.value),
                l.html(n.elemTemp),
            ...
            a.input && !a.range && (e = x('<div class="layui-slider-input"><div class="layui-slider-input-txt"><input type="text" class="layui-input"></div><div class="layui-slider-input-btn"><i class="layui-icon layui-icon-up"></i><i class="layui-icon layui-icon-down"></i></div></div>'),
                l.css("position", "relative"),
                l.append(e),
                l.find("." + E).children("input").val(a.value),
                "vertical" === a.type ? e.css({
                    left: 0,
                    top: -48
                }) : n.elemTemp.css("margin-right", e.outerWidth() + 15)),
                a.disabled ? (n.elemTemp.addClass(f),
                    n.elemTemp.find("." + M).addClass(f)) : n.slide(),
                a.tips && (a.tipsAlways ? (d(s = n.elemTemp.find("." + M)),
                    v(p(s))) : n.elemTemp.find("." + M).on("mouseover", function () {
                        d(x(this));
                        var e = p(x(this));
                        clearTimeout(t),
                        ...
                        clearTimeout(t),
                            a.tipsAlways || n.elemTemp.find("." + L).css("display", "none")
                    }))
        }
        ,
        t.prototype.slide = function (e, t, i) {
            var u = this
                ...
                , h = function (e, t, i) {
                    ...
                    var n, a = y(v[0].offsetLeft), l = c.range ? y(v[1].offsetLeft) : 0, s = ("vertical" === c.type ? (d.find("." + L).css({
                        bottom: e + "%",
                        "margin-bottom": "20px"
                    }),
                        a = y(p() - v[0].offsetTop - v.height()),
                        l = c.range ? y(p() - v[1].offsetTop - v.height()) : 0) : d.find("." + L).css("left", e + "%"),
                        a = 100 < a ? 100 : a,
                        l = 100 < l ? 100 : l,
                        Math.min(a, l)), a = Math.abs(a - l), l = ("vertical" === c.type ? d.find("." + T).css({
                            height: a + "%",
                            bottom: s + "%"
                        }) : d.find("." + T).css({
                            width: a + "%",
                            ...
                            c.min + (c.max - c.min) * e / 100), l = Number(parseFloat(l).toFixed(f));
                    r = l,
                        o.children("." + E).children("input").val(r),
                        v.eq(t).data("value", l),
            ...
            d.find("." + M).each(function (o) {
                ...
                r.on("mousedown touchstart", function (e) {
                    ...
                    t = r,
                        ...
                        n = function (e) {
                            r.removeClass(Y),
                                c.tipsAlways || setTimeout(function () {
                                    d.find("." + L).hide()
                                }, e)
                        }
                        ,
                        a = function () {
                            n && n(b.touchEventsSupported() ? 1e3 : 0),
                                ...
                                b.touchEventsSupported() && (t[0].removeEventListener("touchmove", i, !!b.passiveSupported && {
                                    passive: !1
                                }),
                        ...
                        b.touchEventsSupported() && (t[0].addEventListener("touchmove", i, !!b.passiveSupported && {
                            passive: !1
                        }),
                ...
                d.on("click", function (e) {
                    var t = x("." + M)
                        , i = x(this);
                    !t.is(event.target) && 0 === t.has(event.target).length && t.length && (i = (t = (t = (t = "vertical" === c.type ? p() - e.clientY + i.offset().top - x(window).scrollTop() : e.clientX - i.offset().left - x(window).scrollLeft()) < 0 ? 0 : t) > p() ? p() : t) / p() * 100 / m,
                        t = c.range ? "vertical" === c.type ? Math.abs(t - parseInt(x(v[0]).css("bottom"))) > Math.abs(t - parseInt(x(v[1]).css("bottom"))) ? 1 : 0 : Math.abs(t - v[0].offsetLeft) > Math.abs(t - v[1].offsetLeft) ? 1 : 0 : 0,
                        h(i, t, "done"),
                        e.preventDefault())
                }),
            ...
            var n = function () {
                var e = this.value
                    , e = (e = (e = (e = isNaN(e) ? 0 : e) < c.min ? c.min : e) > c.max ? c.max : e,
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var x = layui.$
        ...
        , j = function (e) {
            ...
            return i.b = t,
                i.s = 0 !== t ? 255 * n / t : 0,
                0 !== i.s ? e.r == t ? i.h = (e.g - e.b) / n : e.g == t ? i.h = 2 + (e.b - e.r) / n : i.h = 4 + (e.r - e.g) / n : i.h = -1,
                t === o && (i.h = 0),
                i.h *= 60,
                i.h < 0 && (i.h += 360),
                i.s *= 100 / 255,
        ...
        , F = function (e) {
            var i, o = {}, t = e.h, n = 255 * e.s / 100, e = 255 * e.b / 100;
            return 0 == n ? o.r = o.g = o.b = e : (e = t % 60 * ((i = e) - (n = (255 - n) * e / 255)) / 60,
    ...
    s.prototype.config = {
        ...
        s.prototype.render = function () {
            ...
            var o = x(['<div class="layui-unselect layui-colorpicker">', "<span " + ("rgb" == i.format && i.alpha ? 'class="layui-colorpicker-trigger-bgcolor"' : "") + ">", '<span class="layui-colorpicker-trigger-span" ', 'lay-type="' + ("rgb" == i.format ? i.alpha ? "rgba" : "torgb" : "") + '" ', 'style="' + (o = "",
                i.color ? (o = i.color,
                    3 < (i.color.match(/[0-9]{1,3}/g) || []).length && (i.alpha && "rgb" == i.format || (o = "#" + H(j(L(i.color))))),
                    "background: " + o) : o) + '">', '<i class="layui-icon layui-colorpicker-trigger-i ' + (i.color ? C : w) + '"></i>', "</span>", "</span>", "</div>"].join(""))
                , t = i.elem = x(i.elem);
        ...
        s.prototype.renderPicker = function () {
            var o, e = this, i = e.config, t = e.elemColorBox[0], n = e.elemPicker = x(['<div id="layui-colorpicker' + e.index + '" data-index="' + e.index + '" class="layui-anim layui-anim-downbit layui-colorpicker-main">', '<div class="layui-colorpicker-main-wrapper">', '<div class="layui-colorpicker-basis">', '<div class="layui-colorpicker-basis-white"></div>', '<div class="layui-colorpicker-basis-black"></div>', '<div class="layui-colorpicker-basis-cursor"></div>', "</div>", '<div class="layui-colorpicker-side">', '<div class="layui-colorpicker-side-slider"></div>', "</div>", "</div>", '<div class="layui-colorpicker-main-alpha ' + (i.alpha ? "layui-show" : "") + '">', '<div class="layui-colorpicker-alpha-bgcolor">', '<div class="layui-colorpicker-alpha-slider"></div>', "</div>", "</div>", i.predefine ? (o = ['<div class="layui-colorpicker-main-pre">'],
            ...
            x(c)[0] && x(c).data("index") == e.index ? e.removePicker(s.thisElemInd) : (e.removePicker(s.thisElemInd),
                x("body").append(n)),
                r.thisId = i.id,
        ...
        s.prototype.val = function () {
            var e, i = this, o = (i.config,
                i.elemColorBox.find("." + T)), t = i.elemPicker.find("." + X), n = o[0].style.backgroundColor;
            n ? (e = j(L(n)),
                o = o.attr("lay-type"),
                i.select(e.h, e.s, e.b),
                "torgb" === o ? t.find("input").val(n) : "rgba" === o ? (o = L(n),
                    3 === (n.match(/[0-9]{1,3}/g) || []).length ? (t.find("input").val("rgba(" + o.r + ", " + o.g + ", " + o.b + ", 1)"),
                        i.elemPicker.find("." + Y).css("left", 280)) : (t.find("input").val(n),
                            n = 280 * n.slice(n.lastIndexOf(",") + 1, n.length - 1),
                            i.elemPicker.find("." + Y).css("left", n)),
                    i.elemPicker.find("." + D)[0].style.background = "linear-gradient(to right, rgba(" + o.r + ", " + o.g + ", " + o.b + ", 0), rgb(" + o.r + ", " + o.g + ", " + o.b + "))") : t.find("input").val("#" + H(e))) : (i.select(0, 100, 100),
                        t.find("input").val(""),
            ...
            var r = this
                ...
                , y = function (e, i, o, t) {
                    ...
                    m.addClass(C).removeClass(w),
                        ...
                        "torgb" === a ? i.val("rgb(" + n.r + ", " + n.g + ", " + n.b + ")") : "rgba" === a ? (f.css("left", 280 * t),
                            i.val("rgba(" + n.r + ", " + n.g + ", " + n.b + ", " + t + ")"),
                            c[0].style.background = "rgba(" + n.r + ", " + n.g + ", " + n.b + ", " + t + ")",
                            u[0].style.background = "linear-gradient(to right, rgba(" + n.r + ", " + n.g + ", " + n.b + ", 0), rgb(" + n.r + ", " + n.g + ", " + n.b + "))") : i.val("#" + e),
                        l.change && l.change(x.trim(r.elemPicker.find("." + X).find("input").val()))
                }
            ...
            o.on("mousedown", function (e, i) {
                ...
                d.on("mousedown", function (e) {
                    var i = e.clientY - x(this).offset().top + W.scrollTop()
                        ...
                        , o = ((i = i < 0 ? 0 : i) > this.offsetHeight && (i = this.offsetHeight),
                ...
                , o = {
                    clear: function (e) {
                        s[0].style.background = "",
                            c.elemColorBox.find("." + B).removeClass(C).addClass(w),
                            c.color = "",
                            a.done && a.done(""),
                            c.removePicker()
                    },
                    confirm: function (e, i) {
                        var o, t, n, r, l = x.trim(d.val());
                        -1 < l.indexOf(",") ? (t = j(L(l)),
                            c.select(t.h, t.s, t.b),
                            s[0].style.background = o = "#" + H(t),
                            3 < (l.match(/[0-9]{1,3}/g) || []).length && "rgba" === s.attr("lay-type") && (n = 280 * l.slice(l.lastIndexOf(",") + 1, l.length - 1),
                                c.elemPicker.find("." + Y).css("left", n),
                                o = s[0].style.background = l)) : (3 === (n = -1 < (n = l).indexOf("#") ? n.substring(1) : n).length && (n = (r = n.split(""))[0] + r[0] + r[1] + r[1] + r[2] + r[2]),
                                    r = {
                                    ...
                                    t = j(r),
                                    s[0].style.background = o = "#" + H(t),
                                    c.elemColorBox.find("." + B).removeClass(w).addClass(C)),
        ...
        a.on(i, function (e) {
            var i, o, t;
            r.thisId && (i = n.getThis(r.thisId)) && (o = i.config,
                t = i.elemColorBox.find("." + T),
                x(e.target).hasClass(l) || x(e.target).parents("." + l)[0] || x(e.target).hasClass(c.replace(/\./g, "")) || x(e.target).parents(c)[0] || i.elemPicker && (i.color ? (e = j(L(i.color)),
                    i.select(e.h, e.s, e.b)) : i.elemColorBox.find("." + B).removeClass(C).addClass(w),
        ...
        W.on("resize", function () {
            if (r.thisId) {
                ...
                if (e)
                    return !(!e.elemPicker || !x(c)[0]) && void e.position()
            }
        }),
        n.that = {},
    ...
    var u = layui.$
        ...
        , w = {
            tabClick: function (t) {
                ...
                l || n || (a.addClass(h).siblings().removeClass(h),
                    (o ? t = (t = i.filter('[lay-id="' + o + '"]')).length ? t : i.eq(c) : i.eq(c)).addClass(y).siblings().removeClass(y)),
            ...
            tabDelete: function (t, i) {
                var i = i || u(this).parent()
                    ...
                    , n = e.attr("lay-filter")
                    , s = i.attr("lay-id");
                !1 !== layui.event.call(i[0], r, "tabBeforeDelete(" + n + ")", {
                    elem: e,
                    index: a,
                    id: s
                }) && (i.hasClass(h) && (i.next()[0] && i.next().is("li") ? w.tabClick.call(i.next()[0], {
                    index: a + 1
            ...
            tabAuto: function (l, t) {
                ...
                (t || u(".layui-tab")).each(function () {
                    ...
                    e && "false" !== e && a.find("li").each(function () {
                        var t, i = u(this);
                        i.find("." + o)[0] || "false" === i.attr("lay-allowclose") || ((t = u('<i class="layui-icon layui-icon-close layui-unselect ' + o + '"></i>')).on("click", w.tabDelete),
                            i.append(t))
                    }),
                        "string" != typeof t.attr("lay-unauto") && (a.prop("scrollWidth") > a.outerWidth() + 1 || a.find("li").length && a.height() > (e = a.find("li").eq(0).height()) + e / 2 ? ("change" === l && a.data("LAY_TAB_CHANGE") && a.addClass(n),
                            a.find("." + s)[0] || (a.append(i),
                                t.attr("overflow", ""),
            ...
            clickThis: function () {
                ...
                if ("javascript:;" !== t.attr("href") && "_blank" === t.attr("target") || n || l[0] || (i.find("." + h).removeClass(h),
                    e.addClass(h)),
                    i.hasClass(v)) {
                    var n = p + "ed"
                        , s = !e.hasClass(n)
                    ...
                    l.removeClass(C),
                        l[0] && (s ? (l.slideDown(200, o),
                            ...
                            "string" != typeof i.attr("lay-accordion") && "all" !== i.attr("lay-shrink") || ((s = e.siblings("." + n)).removeClass(n),
                                s.children("." + m).show().stop().slideUp(200, o)))
                }
                ...
                , e = {
                    ...
                    nav: function (t) {
                        var s = {}
                            ...
                            , c = {}
                            , r = "layui-nav-title";
                        (t || u(f + a)).each(function (t) {
                            var i = u(this)
                                , a = u('<span class="' + b + '"></span>')
                                , e = i.find("." + p);
                            i.find("." + b)[0] || (i.append(a),
                                (i.hasClass(v) ? e.find("dd,>." + r) : e).on("mouseenter", function () {
                                    !function (t, i, a) {
                                        var e, l = u(this), n = l.find("." + m);
                                        i.hasClass(v) ? n[0] || (e = l.children("." + r),
                                            t.css({
                                ...
                                e.find("a").each(function () {
                                    var t = u(this);
                                    t.parent();
                                    t.siblings("." + m)[0] && !t.children("." + g)[0] && t.append('<i class="layui-icon layui-icon-down ' + g + '"></i>'),
...
layui.define(["lay", "layer"], function (e) {
    ...
    var F = layui.$
        ...
        , w = {
            ...
            set: function (e) {
                var t = this;
                return t.config = F.extend({}, t.config, e),
                    t
            },
            on: function (e, t) {
                return layui.onevent.call(this, i, e, t)
    ...
    D.prototype.config = {
        ...
        D.prototype.render = function (e) {
            ...
            return 1 < n.length ? (layui.each(n, function () {
                ...
                t) : (F.extend(i, a.options(n[0], {
                    ...
                    !e && n[0] && n.data(s) ? (e = o.getThis(n.data(s))) ? e.reload(i) : void 0 : (i.elem = F(i.elem),
        ...
        D.prototype.initIE = function () {
            var i, e = this.config, t = F('<iframe id="' + E + '" class="' + E + '" name="' + E + '" frameborder="0"></iframe>'), n = F(['<form target="' + E + '" class="' + l + '" method="post" key="set-mine" enctype="multipart/form-data" action="' + e.url + '">', "</form>"].join(""));
            F("#" + E)[0] || F("body").append(t),
                e.elem.next().hasClass(l) || (this.elemFile.wrap(n),
                    e.elem.next("." + l).append((i = [],
        ...
        D.prototype.upload = function (e, t) {
            var i, n, a, o, r, u = this, f = u.config, s = f.text || {}, l = u.elemFile[0], c = function () {
                ...
                u.elemFile.parent().submit(),
                    ...
                    D.timer = setInterval(function () {
                        ...
                        try {
                            ...
                            u.msg(s["cross-domain"]),
                                clearInterval(D.timer),
                                g()
                        }
                        e && (clearInterval(D.timer),
                            t.html(""),
                            m(0, e))
                    }, 30)
            }, h = function (e) {
                ...
                n), x = {
                    ...
                    video: "\u89c6\u9891",
                    audio: "\u97f3\u9891"
                }[f.accept] || "\u6587\u4ef6", y = 0 === y.length ? l.value.match(/[^\/\\]+\..+/g) || [] : y;
            if (0 !== y.length) {
                switch (f.accept) {
                    case "file":
                    ...
                    case "video":
                        layui.each(y, function (e, t) {
                            if (!RegExp(".\\.(" + (v || "avi|mp4|wma|rmvb|rm|flash|3gp|flv") + ")$", "i").test(escape(t)))
                                return i = !0
                        });
                        break;
                    case "audio":
                    ...
                    default:
                        layui.each(y, function (e, t) {
                            if (!RegExp(".\\.(" + (v || "jpg|png|gif|bmp|jpeg|svg|webp") + ")$", "i").test(escape(t)))
                                return i = !0
                        })
                }
                if (i)
                    return u.msg(s["check-error"] || "\u9009\u62e9\u7684" + b + "\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"),
                        l.value = "";
                if ("choose" !== t && !f.auto || (f.choose && f.choose(x),
                    "choose" !== t)) {
                    if (u.fileLength = (a = 0,
                        b = c(),
                        ...
                        return u.msg("function" == typeof s["limit-number"] ? s["limit-number"](f, u.fileLength) : "\u540c\u65f6\u6700\u591a\u53ea\u80fd\u4e0a\u4f20: " + f.number + " \u4e2a\u6587\u4ef6<br>\u60a8\u5f53\u524d\u5df2\u7ecf\u9009\u62e9\u4e86: " + u.fileLength + " \u4e2a\u6587\u4ef6");
                    if (0 < f.size && !(R.ie && R.ie < 10))
                        if (layui.each(c(), function (e, t) {
                            t.size > 1024 * f.size && (t = 1 <= (t = f.size / 1024) ? t.toFixed(2) + "MB" : f.size + "KB",
                                l.value = "",
                                o = t)
                        }),
                            o)
            ...
            var a = this
                ...
                , r = function (e, t) {
                    ...
                    i.next().hasClass(L) && i.next().remove(),
                        ...
                        a.isFile() || n.choose || i.after('<span class="layui-inline ' + L + '">' + e + "</span>")
                }
                , l = function (i) {
                    var n = !0;
            ...
            n.elem.off("upload.start").on("upload.start", function () {
                ...
                n.elem.data(s) || (n.elem.on("click", function () {
                    ...
                    n.drag && n.elem.on("dragover", function (e) {
                        e.preventDefault(),
                            F(this).trigger("upload.over")
                    }).on("dragleave", function (e) {
                        F(this).trigger("upload.leave")
                    }).on("drop", function (e) {
                        e.preventDefault(),
                            F(this).trigger("upload.drop", e)
                    }),
        ...
        w.util = {
            parseSize: function (e, t) {
                var i, n;
                return t = t || 2,
                    null != e && e ? (i = "string" == typeof e ? parseFloat(e) : e,
                        n = Math.floor(Math.log(i) / Math.log(1024)),
                        (e = (e = i / Math.pow(1024, n)) % 1 == 0 ? e : parseFloat(e.toFixed(t))) + ["Bytes", "Kb", "Mb", "Gb", "Tb", "Pb", "Eb", "Zb", "Yb"][n]) : "0"
            },
...
layui.define(["lay", "layer", "util"], function (e) {
    ...
    var T = layui.$
        ...
        , i = (t.prototype.set = function (e) {
            return T.extend(!0, this.config, e),
                this
        }
            ,
            t.prototype.verify = function (e) {
                return T.extend(!0, this.config.verify, e),
                    this
            }
            ,
            ...
            t.prototype.render = function (e, t) {
                    ...
                    , n = {
                                ...
                                , t = (i.autocomplete && e.attr("autocomplete", i.autocomplete),
                                    function (e, t) {
                                        var i = e.val()
                                            ...
                                            , o = "click" !== t && "" === i
                                            , c = "init" === t;
                                        isNaN(a) || ("click" === t && (a = !!T(this).index() ? a - n : a + n),
                                            t = function (e) {
                                            ...
                                            }).increment[r <= a && !o ? "addClass" : "removeClass"](S),
                                                n.decrement[a <= l && !o ? "addClass" : "removeClass"](S))
                                    }
                                );
                            a.find("input[lay-affix],textarea[lay-affix]").each(function () {
                                var r = T(this)
                                    ...
                                    , n = function (i) {
                                        ...
                                        var a, t = T('<div class="' + u + '">'), e = layui.isArray(i.value) ? i.value : [i.value], e = T((a = [],
                                            layui.each(e, function (e, t) {
                                                a.push('<i class="layui-icon layui-icon-' + t + (i.disabled ? " " + S : "") + '"></i>')
                                            }),
                                            a.join(""))), n = (t.append(e),
                                        ...
                                        l[0] ? ((n = l.find("." + u))[0] && n.remove(),
                                            ...
                                            e.on("click", function () {
                                                ...
                                                T(this).hasClass(S) || ("function" == typeof i.click && i.click.call(this, r, i),
                        ...
                        select: function (e) {
                            var p = "\u8bf7\u9009\u62e9"
                                , C = "layui-form-select"
                                , w = "layui-select-none"
                                , _ = "layui-select-create-option"
                                , f = "layui-select-panel-elem-data"
                                , e = e || a.find("select")
                                , y = function (n, e, t, i, u, a) {
                                    var l, d, r, s, o, c, h, p, f, y = T(this), v = e, m = v.find("input"), g = n.find("dl"), b = (g.children("dd"),
                                        g.children("dt")), k = this.selectedIndex, x = "";
                                    t || (d = "cs" === y.attr("lay-search") ? {
                                        caseSensitive: !0
                                    } : lay.options(y, {
                                        attr: "lay-search"
                                    }),
                                        ...
                                        o = !(!lay.ie || "10" !== lay.ie && "11" !== lay.ie || !m.attr("placeholder")),
                                        c = function () {
                                            a && (n.appendTo(r).css({
                                                width: v.width() + "px"
                                            }),
                                            ...
                                            var e = n.offset().top + n.outerHeight() + 5 - O.scrollTop()
                                                , t = g.outerHeight()
                                                , i = g.children("dd");
                                            k = y[0].selectedIndex,
                                                ...
                                                b.removeClass(j),
                                                i.removeClass(A),
                                                0 <= k && i.eq(k).addClass(A),
                                                e + t > O.height() && t <= e && n.addClass(C + "up"),
                                                p(),
                                                o && g.off("mousedown.lay_select_ieph").on("mousedown.lay_select_ieph", function () {
                                                    m[0].__ieph = !0,
                                                        setTimeout(function () {
                                                            m[0].__ieph = !1
                                                        }, 60)
                                        ...
                                        h = function (e) {
                                            v.parent().removeClass(C + "ed " + C + "up"),
                                                m.blur(),
                                                u && g.children("." + _).remove(),
                                                l && l(),
                                                a && (n.detach(),
                                                    T(window).off("resize.lay_select_resize")),
                                                e || f(m.val(), function (e) {
                                                    var t = y[0].selectedIndex;
                                                    e && (x = T(y[0].options[t]).html(),
                                        ...
                                        ,
                                        p = function () {
                                            var e, t, i = g.children("dd." + A);
                                            i[0] && (e = i.position().top,
                                                t = g.height(),
                                                i = i.height(),
                                                t < e && g.scrollTop(e + g.scrollTop() - t + i - 5),
                                                e < 0) && g.scrollTop(e + g.scrollTop() - 5)
                                        }
                                        ,
                                        v.on("click", function (e) {
                                            (v.parent().hasClass(C + "ed") ? h : c)(),
                                                g.find("." + w).remove()
                                        }),
                                        ...
                                        m.on("keyup", function (e) {
                                            ...
                                            var e = n.keyCode
                                                , t = (9 === e && h(),
                                                    function (e) {
                                                        n.preventDefault();
                                                        var t, i, a = g.children("dd:not(." + j + ",." + S + ")");
                                                        a.length && (t = a.length - 1,
                                                            ...
                                                            e = "prev" === e ? i - 1 < 0 ? t : i - 1 : t < i + 1 ? 0 : i + 1,
                                            ...
                                            38 === e && t("prev"),
                                                ...
                                                13 === e && (n.preventDefault(),
                                                    g.children("dd." + A).trigger("click"))
                                        }).on("paste", function () {
                                            c()
                                        }),
                                        f = function (n, e, l) {
                                            var r, s = 0, t = g.children("dd"), o = !1, c = n, t = (d.caseSensitive || (n = n.toLowerCase()),
                                                d.fuzzy && (r = function (e, t) {
                                                    var i = {}
                                                        , a = ["^"];
                                                    t || (e = e.toLowerCase());
                                                ...
                                                "keyup" === l && layui.each(b, function () {
                                                    ...
                                                    e[(t = u ? t.not("." + _) : t).length == t.filter("." + j).length ? "addClass" : "removeClass"](j)
                                                }),
                                                s === t.length);
                                            return e(t, o),
                                                t
                                        ...
                                        i && m.on("input propertychange", layui.debounce(function (e) {
                                            var n = this.value
                                                , t = e.keyCode;
                                            return 9 !== t && 13 !== t && 37 !== t && 38 !== t && 39 !== t && 40 !== t && (o && e.target.__ieph ? e.target.__ieph = !1 : (f(n, function (e, t) {
                                                var i, a;
                                                u ? t ? g.children("." + _).remove() : (t = g.children("." + _))[0] ? t.attr("lay-value", n).html(N.escape(n)) : (t = T("<dd>").addClass(_).attr("lay-value", n).html(N.escape(n)),
                                                    a = (i = g.children().eq(0)).hasClass("layui-select-tips"),
                                                    i[a ? "after" : "before"](t)) : e ? g.find("." + w)[0] || g.append('<p class="' + w + '">\u65e0\u5339\u914d\u9879</p>') : g.find("." + w).remove()
                                            }, "keyup"),
                                                "" === n && (y.val(""),
                                                    g.find("." + A).removeClass(A),
                                                    (y[0].options[0] || {}).value || g.children("dd:eq(0)").addClass(A),
                                                    g.find("." + w).remove(),
                                                    u) && g.children("." + _).remove(),
                                                void p()))
                                        ...
                                        g.on("click", "dd", function () {
                                            var e, t = T(this), i = t.attr("lay-value"), a = y.attr("lay-filter");
                                            return t.hasClass(S) || (t.hasClass("layui-select-tips") ? m.val("") : (m.val(t.text()),
                                                t.addClass(A)),
                                                u && t.hasClass(_) && (g.append(t.removeClass(_)),
                            ...
                            T.event.special["_lay-select-destroy"] = {
                                ...
                                e.each(function (e, t) {
                                    ...
                                    if ("string" == typeof i.attr("lay-ignore"))
                                        return i.show();
                                    var s, o, c = "string" == typeof i.attr("lay-search"), u = "string" == typeof i.attr("lay-creatable") && c, d = "string" == typeof i.attr("lay-append-to"), t = t && !t.value && t.innerHTML || p, h = T(['<div class="' + (c ? "" : "layui-unselect ") + C, (n ? " layui-select-disabled" : "") + '"></div>'].join("")), t = T(['<div class="layui-select-title">', '<input type="text" placeholder="' + N.escape(T.trim(t)) + '" value="' + N.escape(T.trim(l ? r.html() : "")) + '"' + (!n && c ? "" : " readonly") + ' class="layui-input' + (c ? "" : " layui-unselect") + (n ? " " + S : "") + '">', '<i class="layui-edge"></i>', "</div>"].join("")), r = T(['<dl class="layui-anim layui-anim-upbit' + (i.find("optgroup")[0] ? " layui-select-group" : "") + '">', (r = i.find("*"),
                                        s = [],
                                        layui.each(r, function (e, t) {
                                            var i = t.tagName.toLowerCase();
                                            0 !== e || t.value || "optgroup" === i ? s.push("optgroup" === i ? "<dt>" + t.label + "</dt>" : '<dd lay-value="' + N.escape(t.value) + '" class="' + (l === t.value ? A : "") + (t.disabled ? " " + S : "") + '">' + T.trim(t.innerHTML) + "</dd>") : s.push('<dd lay-value="" class="layui-select-tips">' + T.trim(t.innerHTML || p) + "</dd>")
                                        }),
                                        0 === s.length && s.push('<dd lay-value="" class="' + S + '">\u6ca1\u6709\u9009\u9879</dd>'),
                                        s.join("") + "</dl>")].join(""));
                                    a[0] && (d && (o = a.data(f)) && o.remove(),
                                        a.remove()),
                                        d ? (h.append(t),
                                            i.after(h),
                                            o = T('<div class="' + C + ' layui-select-panel-wrap"></div>').append(r),
                                            h.data(f, o),
                                            y.call(this, o, t, n, c, u, d)) : (h.append(t).append(r),
                                                i.after(h),
                                                y.call(this, h, t, n, c, u, d))
                                })
                        },
                        checkbox: function (e) {
                            var c = {
                            ...
                            e.each(function (e, t) {
                                var i = T(this)
                                    ...
                                    , o = (s[0] && s.remove(),
                                        []);
                                if (i.next("[lay-checkbox]")[0] && (s = i.next(),
                                    n = s.html() || "",
                                    1 < s[0].attributes.length) && layui.each(s[0].attributes, function (e, t) {
                                    ...
                                    return i.show();
                                l = T(['<div class="layui-unselect ' + r[0], t.checked ? " " + r[1] : "", l ? " layui-checkbox-disabled " + S : "", '"', a ? ' lay-skin="' + a + '"' : "", ">", (s = {
                                ...
                                i.after(l),
                                    function (t, i) {
                                        ...
                                        t.on("click", function () {
                                            ...
                                            a[0].disabled || (a[0].indeterminate && (a[0].indeterminate = !1),
                                                a[0].checked = !a[0].checked,
                                                layui.event.call(a[0], $, i[2] + "(" + e + ")", {
                                                    elem: a[0],
                                                    value: a[0].value,
                                                    othis: t
                                                }))
                                            ...
                                            u.syncAppearanceOnPropChanged(this, "checked", function () {
                                                var e;
                                                n && (e = (t.next("*[lay-checkbox]")[0] ? t.next().html() : a.attr("title") || "").split("|"),
                        ...
                        radio: function (e) {
                            ...
                            e.each(function (e, t) {
                                ...
                                var a = N.escape(t.title || "")
                                    , r = []
                                    , s = (i.next("[lay-radio]")[0] && (a = (s = i.next()).html() || "",
                                        1 < s[0].attributes.length) && layui.each(s[0].attributes, function (e, t) {
                                            "lay-radio" !== t.name && r.push(t.name + '="' + t.value + '"')
                                        }),
                                        r = r.join(" "),
                                        T(['<div class="layui-unselect ' + o, t.checked ? " " + o + "ed" : "", (n ? " layui-radio-disabled " + S : "") + '"', l ? ' lay-skin="' + l + '"' : "", ">", '<i class="layui-anim layui-icon ' + c[t.checked ? 0 : 1] + '"></i>', "<div " + r + ">" + a + "</div>", "</div>"].join("")));
                                i.after(s),
                                    function (i) {
                                        var a = T(this)
                                        ...
                                        i.on("click", function () {
                                            var e = a.attr("lay-filter");
                                            a[0].disabled || (a[0].checked = !0,
                                                layui.event.call(a[0], $, "radio(" + e + ")", {
                                                    elem: a[0],
                                                    value: a[0].value,
                                                    othis: i
                                                }))
                                            ...
                                            u.syncAppearanceOnPropChanged(this, "checked", function () {
                                                ...
                                                t.checked ? (i.addClass(o + "ed"),
                                                    ...
                                                    layui.each(e, function () {
                                                        ...
                                                        i.children(".layui-icon").removeClass(n + " " + c[0]).addClass(c[1]))
                                            })
                                    }
                                        .call(this, s)
                            })
                ...
                return "object" === layui.type(e) ? T(e).is(d) ? (a = T(e),
                    t()) : e.each(function (e, t) {
                        var i = T(t);
                        i.closest(d).length && ("SELECT" === t.tagName ? n.select(i) : "INPUT" === t.tagName && ("checkbox" === (t = t.type) || "radio" === t ? n[t](i) : n.input(i)))
            ...
            t.prototype.validate = function (e) {
                var u, d = this.config.verify, h = "layui-form-danger";
                return !(e = T(e))[0] || (e.attr("lay-verify") !== undefined || !1 !== this.validate(e.find("*[lay-verify]"))) && (layui.each(e, function (e, r) {
                    var s = T(this)
                        ...
                        layui.each(t, function (e, t) {
                            ...
                            if (a) {
                                ...
                                if ("required" === t && (i = s.attr("lay-reqtext") || i),
                                    n)
                                    return "tips" === o ? p.tips(i, "string" != typeof s.attr("lay-ignore") && l ? s.next() : s, {
                                        tips: 1
                                    }) : "alert" === o ? p.alert(i, {
                                        title: "\u63d0\u793a",
                                        shadeClose: !0
            ...
            t.prototype.submit = function (e, t) {
                var i = {}
                    ...
                    , n = this.getFormElem ? this.getFormElem(e) : a.parents(d).eq(0)
                    , l = n.find("*[lay-verify]");
...
layui.define(["lay", "laytpl", "laypage", "form", "util"], function (s) {
    ...
    var p = layui.$
        ...
        , x = {
            ...
            set: function (e) {
                return this.config = p.extend({}, this.config, e),
                    this
            },
            on: function (e, t) {
        ...
        , w = function (e) {
            var t = k.that[e];
            return t || g.error(e ? "The table instance with ID '" + e + "' not found" : "ID argument required"),
                t || null
        }
        , l = function (e) {
            var t = k.config[e];
        ...
        , j = "layui-table-expanded"
        , I = "layui-table-disabled-transition"
        ...
        , c = (n.prototype.config = {
                ...
                a.index = t.index,
                    ...
                    a.height && /^full-.+$/.test(a.height) ? (t.fullHeightGap = a.height.split("-")[1],
                        a.height = d.height() - (parseFloat(t.fullHeightGap) || 0)) : a.height && /^#\w+\S*-.+$/.test(a.height) ? (i = a.height.split("-"),
                            ...
                            t.parentDiv = i.join("-"),
                            a.height = p(t.parentDiv).height() - (parseFloat(t.parentHeightGap) || 0)) : "function" == typeof a.height && (t.customHeightFunc = a.height,
            ...
            n.prototype.renderToolbar = function () {
                var l, o = this, e = o.config, d = e.elem.attr("lay-filter"), t = ['<div class="layui-inline" lay-event="add"><i class="layui-icon layui-icon-add-1"></i></div>', '<div class="layui-inline" lay-event="update"><i class="layui-icon layui-icon-edit"></i></div>', '<div class="layui-inline" lay-event="delete"><i class="layui-icon layui-icon-delete"></i></div>'].join(""), a = o.layTool.find(".layui-table-tool-temp"), n = ("default" === e.toolbar ? a.html(t) : "string" == typeof e.toolbar && (t = p(e.toolbar).html() || "") && a.html(m(t).render(e)),
                {
                    filter: {
                        title: "\u7b5b\u9009\u5217",
                                ...
                                e.openPanel)({
                                    list: (a = [],
                                        o.eachCols(function (e, t) {
                                            t.field && "normal" == t.type && a.push('<li><input type="checkbox" name="' + t.field + '" data-key="' + t.key + '" data-parentkey="' + (t.parentKey || "") + '" lay-skin="primary" ' + (t.hide ? "" : "checked") + ' title="' + v.escape(p("<div>" + (t.fieldTitle || t.title || t.field) + "</div>").text()) + '" lay-filter="LAY_TABLE_TOOL_COLS"></li>')
                                        }),
                                        a.join("")),
                                    done: function () {
                                        i.on("checkbox(LAY_TABLE_TOOL_COLS)", function (e) {
                                            ...
                                            i.key && (i.hide = !t,
                                                ...
                                                o.resize(),
                                                layui.event.call(this, T, "colToggled(" + d + ")", {
                                                    col: i,
                                                    config: n
                                                }))
                                        })
                    ...
                    exports: {
                        ...
                        onClick: function (e) {
                            var t = e.data
                                ...
                                , e = e.elem;
                            if (!t.length)
                                return f.tips("\u5f53\u524d\u8868\u683c\u65e0\u6570\u636e", e, {
                                    tips: 3
                                });
                            b.ie ? f.tips("\u5bfc\u51fa\u529f\u80fd\u4e0d\u652f\u6301 IE\uff0c\u8bf7\u7528 Chrome \u7b49\u9ad8\u7ea7\u6d4f\u89c8\u5668\u5bfc\u51fa", e, {
                                tips: 3
                            }) : i({
            ...
            n.prototype.setGroupWidth = function (i) {
                var e, l = this;
                l.config.cols.length <= 1 || ((e = l.layHeader.find((i ? "th[data-key=" + i.data("parentkey") + "]>" : "") + "." + u)).css("width", 0),
                                    ...
                                    l.colGroup || (e = ['<td data-field="' + e + '" data-key="' + a + '" ' + (e = [],
                                        ...
                                        e.join(" ")) + ' class="' + (t = [],
                                            ...
                                            t.join(" ")) + '">', '<div class="layui-table-cell laytable-cell-' + ("normal" === l.type ? a : a + " laytable-cell-" + l.type) + '"' + (l.align ? ' align="' + l.align + '"' : "") + ">" + function () {
                                                ...
                                                return l.toolbar ? m(p(l.toolbar).html() || "").render(t) : C.call(s, {
                                                    item3: l,
                                                    content: n,
                                                    tplData: t
                                                })
            ...
            n.prototype.renderData = function (e) {
                ...
                return x.cache[a.key] = d,
                    ...
                    a.layPage.find(O)[!i.page || 0 == n || 0 === d.length && 1 == l ? "addClass" : "removeClass"](y),
            ...
            n.prototype.setRowChecked = function (i) {
                var a, e, l, t, n, o, d, r = this, c = r.config, s = "all" === i.index, u = "array" === layui.type(i.index), y = s || u;
                y && (r.layBox.addClass(I),
                    "radio" === i.type) || (u && (a = {},
                        ...
                        e.each(function () {
                            var e = p(this)
                                , t = e.attr("data-index")
                                , a = l[t];
                            t && "array" !== layui.type(a) && !a[c.disabledName] && (a = a[c.checkName] = n(e.hasClass(_)),
                                e.toggleClass(_, !!a),
                                "radio" === i.type) && (o = t,
                                    e.siblings().removeClass(_))
                        }),
                        ...
                        }[i.type] || "checkbox") + '"]:not(:disabled)')).last()).closest(z),
                        ("radio" === i.type && d.hasClass(R) ? s.first() : s).prop("checked", n(u.prop("checked"))),
                        r.syncCheckAll(),
                        y && setTimeout(function () {
                            r.layBox.removeClass(I)
                        }, 100))
            }
            ,
            n.prototype.sort = function (l) {
                ...
                try {
                    ...
                    g.error("Table modules: sort field '" + d + "' not matched")
                }
                t.sortKey = {
                    field: d,
                    sort: l.type
            ...
            n.prototype.fullSize = function () {
                ...
                i.fullHeightGap ? (l = d.height() - i.fullHeightGap) < 135 && (l = 135) : i.parentDiv && i.parentHeightGap ? (l = p(i.parentDiv).height() - i.parentHeightGap) < 135 && (l = 135) : i.customHeightFunc && (l = i.customHeightFunc()) < 135 && (l = 135),
            ...
            n.prototype.scrollPatch = function () {
                ...
                e.layFixed.find(E).css("height", t.height() >= n ? n : "auto").scrollTop(e.layMain.scrollTop()),
                    e.layFixRight[x.cache[e.key] && x.cache[e.key].length && 0 < l ? "removeClass" : "addClass"](R),
                ...
                var c = this
                    ...
                    , y = (c.layTool.on("click", "*[lay-event]", function (e) {
                        ...
                        layui.stope(e),
                            ...
                            layui.each(s.defaultToolbar, function (e, t) {
                                if (t.layEvent === a)
                                    return "function" == typeof t.onClick && t.onClick({
                                        data: l,
                                        config: s,
                                        openPanel: n,
                                        elem: i
                            ...
                            layui.event.call(this, T, "toolbar(" + o + ")", p.extend({
                                event: a,
                                config: s
                            }, {}))
                    }),
                        c.layHeader.on("click", "*[lay-event]", function (e) {
                            var t = p(this)
                                ...
                                , t = c.col(t);
                            layui.event.call(this, T, "colTool(" + o + ")", p.extend({
                                event: a,
                                config: s,
                                col: t
                            }, {}))
                        ...
                        c.layPagebar.on("click", "*[lay-event]", function (e) {
                            ...
                            layui.event.call(this, T, "pagebar(" + o + ")", p.extend({
                                event: t,
                                config: s
                            }, {}))
                        }),
                        e.on("mousemove", function (e) {
                            var t = p(this)
                                , a = t.offset().left
                                , e = e.clientX - a;
                            t.data("unresize") || k.eventMoveElem || (r.allowResize = t.width() - e <= 10,
                                d.css("cursor", r.allowResize ? "col-resize" : ""))
                        }).on("mouseleave", function () {
                            p(this);
                            k.eventMoveElem || (r.allowResize = !1,
                                d.css("cursor", ""))
                        }).on("mousedown", function (e) {
                            var t, a = p(this);
                            r.allowResize && (t = a.data("key"),
                                e.preventDefault(),
                        ...
                        k.docEvent || F.on("mousemove", function (e) {
                            var t, a;
                            k.eventMoveElem && (t = k.eventMoveElem.data(S) || {},
                                k.eventMoveElem.data("resizing", 1),
                                e.preventDefault(),
                                t.rule) && (e = t.ruleWidth + e.clientX - t.offset[0],
                                    a = k.eventMoveElem.closest("." + D).attr(N),
                                    a = w(a)) && ((e = e < t.minWidth ? t.minWidth : e) > t.maxWidth && (e = t.maxWidth),
                                        t.rule.style.width = e + "px",
                                        a.setGroupWidth(k.eventMoveElem),
                                        f.close(c.tipsIndex))
                        }).on("mouseup", function (e) {
                            var t, a, i, l, n;
                            k.eventMoveElem && (i = (t = k.eventMoveElem).closest("." + D).attr(N),
                                a = w(i)) && (i = t.data("key"),
                                    l = a.col(i),
                    ...
                    , t = (c.elem.on("click", 'input[name="layTableCheckbox"]+', function (e) {
                        ...
                        t[0].disabled || (n ? c.setRowChecked({
                            ...
                            layui.stope(e),
                            layui.event.call(t[0], T, "checkbox(" + o + ")", y.call(t[0], {
                                checked: l,
                                type: n ? "all" : "one",
                                getCol: function () {
                        ...
                        c.elem.on("click", 'input[lay-type="layTableRadio"]+', function (e) {
                            ...
                            c.setRowChecked({
                                ...
                                layui.event.call(t[0], T, "radio(" + o + ")", y.call(t[0], {
                                    checked: i,
                                    getCol: function () {
                                        return c.col(a.data("key"))
                                    }
                        ...
                        function (e, t) {
                            ...
                            if (!a.data("off")) {
                                if ("rowContextmenu" !== e) {
                                    ...
                                    if (p(t.target).is(i) || p(t.target).closest(i)[0])
                                        return
                                }
                                layui.event.call(this, T, e + "(" + o + ")", y.call(a.children("td")[0], {
                                    e: t
                                }))
                            }
                        }
                    ...
                    , n = function (e, t) {
                        ...
                        (e = p(e)).data("off") || (l = e.data("field"),
                            ...
                            a = x.cache[c.key][a],
                            e.children(u),
                            (i = "function" == typeof i.edit ? i.edit(a) : i.edit) && ((i = p("textarea" === i ? '<textarea class="layui-input ' + L + '" lay-unrow></textarea>' : '<input class="layui-input ' + L + '" lay-unrow>'))[0].value = (l = e.data("content") || a[l]) === undefined || null === l ? "" : l,
                                e.find("." + L)[0] || e.append(i),
                                i.focus(),
                                t) && layui.stope(t))
                    }
                    , i = (c.layBody.on("change", "." + L, function () {
                        var e = p(this)
                            , t = e.parent()
                            , a = this.value
                        ...
                        e[i] = a,
                            l.update(e),
                            layui.event.call(t[0], T, "edit(" + o + ")", l)
                    }).on("blur", "." + L, function () {
                        p(this).remove()
                    }),
                    ...
                    , a = function (e) {
                        var t = p(this)
                            , a = t.children(u);
                        t.data("off") || t.parent().hasClass(j) || (e ? t.find(".layui-table-grid-down").remove() : !(a.prop("scrollWidth") > a.prop("clientWidth") || 0 < a.find("br").length) || s.lineStyle || a.find("." + i)[0] || t.append('<div class="' + i + '"><i class="layui-icon layui-icon-down"></i></div>'))
                    }
                    , l = function (e, t) {
                        var a = p(this)
                            , i = a.parent()
                            ...
                            , r = p('<i class="layui-icon layui-icon-up ' + i + '">');
                        "tips" === (t = t || n.expandedMode || s.cellExpandedMode) ? c.tipsIndex = f.tips(['<div class="layui-table-tips-main" style="margin-top: -' + (d.height() + 23) + "px;" + ("sm" === s.size ? "padding: 4px 15px; font-size: 12px;" : "lg" === s.size ? "padding: 14px 15px;" : "") + '">', d.html(), "</div>", '<i class="layui-icon layui-table-tips-c layui-icon-close"></i>'].join(""), d[0], {
                            tips: [3, ""],
                            time: -1,
                            anim: -1,
                    ...
                    , h = (c.layBody.on("click", "." + i, function (e) {
                        ...
                        function (e) {
                            ...
                            c.setRowActive(i),
                                layui.event.call(this, T, (e || "tool") + "(" + o + ")", y.call(this, {
    ...
    x.eachCols = function (e, a, i) {
        ...
        x.checkStatus = function (e) {
            var a = 0
                ...
                , e = x.cache[e] || [];
            return layui.each(e, function (e, t) {
                "array" === layui.type(t) || t[x.config.disabledName] ? i++ : t[x.config.checkName] && (a++,
        ...
        ,
        x.resize = function (e) {
            e ? l(e) && w(e).resize() : layui.each(k.that, function () {
                this.resize()
            })
        }
        ,
        x.exportFile = function (e, t, a) {
            ...
            if (b.ie)
                return g.error("IE_NOT_SUPPORT_EXPORTS");
            ...
            d.href = "data:" + n + ";charset=utf-8,\ufeff" + encodeURIComponent((r = [],
                c = [],
                s = [],
                u = {},
                layui.each(t, function (i, l) {
                    ...
                    "object" == typeof e ? (layui.each(e, function (e, t) {
                        ...
                        layui.each(layui.isArray(l) ? p.extend([], l) : x.clearCacheKey(l), function (e, t) {
                            ...
                            var a;
                            !1 === t.ignoreExport || t.field && "normal" == t.type ? t.hide && !1 !== t.ignoreExport || !0 === t.ignoreExport ? 0 == i && (u[t.field] = !0) : ((a = l[t.field]) !== undefined && null !== a || (a = ""),
                                    ...
                                    obj: {
                                        td: function (e) {
                                            return y && (i = l.LAY_DATA_INDEX),
                                                o.layBody.find('tr[data-index="' + i + '"]>td').filter('[data-field="' + e + '"]')
                                        }
                                    }
                                })).replace(/"/g, '""'),
                                n.push(a = '"' + a + '"')) : t.field && "normal" !== t.type && 0 == i && (u[t.field] = !0)
                        }),
                        c.push(n.join(","))
                }),
...
layui.define(["table"], function (e) {
    ...
    var A = layui.$
        ...
        , d = function (d, a, e) {
            var r = j(d)
                ...
                , i = n.customName.id
                , l = (delete a.hasNumberCol,
                    delete a.hasChecboxCol,
                    delete a.hasRadioCol,
                    P.eachCols(null, function (e, t) {
                        "numbers" === t.type ? a.hasNumberCol = !0 : "checkbox" === t.type ? a.hasChecboxCol = !0 : "radio" === t.type && (a.hasRadioCol = !0)
                    }, o.cols),
                    a.parseData)
                , u = a.done;
            "reloadData" === e && "fixed" === o.scrollPos && (r.scrollTopCache = r.config.elem.next().find(s).scrollTop()),
                o.url ? e && (!l || l.mod) || (a.parseData = function () {
                    var e = this
                        , t = arguments
                        , a = t[0]
                        , t = ("function" === layui.type(l) && (a = l.apply(e, t) || t[0]),
                            e.response.dataName);
                    return n.data.isSimpleData && !n["async"].enable && (a[t] = r.flatToTree(a[t])),
                        N(a[t], function (e) {
                    ...
                    ,
                    a.parseData.mod = !0) : a.data !== undefined && (a.data = a.data || [],
                        n.data.isSimpleData && (a.data = r.flatToTree(a.data)),
                        r.initData(a.data)),
                e && (!u || u.mod) || (a.done = function () {
                    var e, t = arguments, a = t[3], n = "renderData" === a, i = (n || delete r.isExpandAll,
                        this.elem.next()), l = (r.updateStatus(null, {
                            LAY_HAS_EXPANDED: !1
                        }),
                            g(d, c),
                            i.find('[name="layTableCheckbox"][lay-filter="layTableAllChoose"]'));
                    if (l.length && (e = B.checkStatus(d),
                        l.prop({
                        ...
                        r.renderTreeTable(i),
                        "reloadData" === a && "fixed" === this.scrollPos && i.find(s).scrollTop(r.scrollTopCache),
                        "function" === layui.type(u))
                        return u.apply(this, t)
                }
                    ,
                    a.done.mod = !0),
                a && a.tree && a.tree.view && layui.each(f, function (e, t) {
    ...
    a.prototype.init = function () {
        ...
        a.prototype.flatToTree = function (e) {
            var n, i, l, d, r, o, c, u, t = this.getOptions(), a = t.tree, s = a.customName, t = t.id;
            return e = e || P.cache[t],
                t = e,
                n = s.id,
                i = s.pid,
                l = s.children,
    ...
    var r, U = function (e, t, a) {
        ...
        if (v !== undefined && (c.status.expand[v] = x),
            ...
            if (x)
                if (m) {
                    ...
                    var N, I, C, D, T, _, k, w, O, S, E, m = u["async"] || {}, b = m.url || o.url;
                    if (m.enable && y[f] && !y[V])
                        return y[V] = "loading",
                            ...
                            ,
                            C = m.format,
                            "function" === layui.type(C) ? C(y, o, N) : (I = A.extend({}, m.where || o.where),
                                C = m.autoParam,
                                ...
                                A.ajax({
                                    ...
                                    headers: _ || {},
                                    success: function (e) {
                                        (e = "function" == typeof k ? k.call(o, e) || e : e)[w.statusName] != w.statusCode ? (y[V] = "error",
                                            g.html('<i class="layui-icon layui-icon-refresh"></i>')) : N(e[w.dataName])
                                    },
                                    error: function (e, t) {
                                        y[V] = "error",
                            ...
                            h;
                    y[X] = !0,
                        v.length && (!o.initSort || o.url && !o.autoSort || ((m = o.initSort).type ? layui.sort(v, m.field, "desc" === m.type, !0) : layui.sort(v, P.config.indexName, null, !0)),
                            c.initData(y[s.children], y[z]),
                            ...
                            d.find(q).find('tbody tr[lay-data-index="' + e + '"]').after(S.trs),
                            d.find(R).find('tbody tr[lay-data-index="' + e + '"]').after(S.trs_fixed),
                            d.find(Y).find('tbody tr[lay-data-index="' + e + '"]').after(S.trs_fixed_r),
            ...
            U("resize-" + r, function () {
                ...
                l && "loading" !== y[V] && (C = u.callback.onExpand,
        ...
        a.prototype.updateNodeIcon = function (e) {
            var t = this.getOptions().tree || {}
                ...
                , n = e.isExpand
                , e = e.isParent;
            a.find(".layui-table-tree-flexIcon").css("visibility", e || t.view.showFlexIconIfNotParent ? "visible" : "hidden").html(n ? t.view.flexIconOpen : t.view.flexIconClose),
                t.view.showIcon && (a = a.find(".layui-table-tree-nodeIcon:not(.layui-table-tree-iconCustom)"),
        ...
        a.prototype.renderTreeTable = function (e, t, a) {
            var l = this
                ...
                , s = (d.attr("lay-filter"),
                    l)
                , f = ((t = t || 0) || (d.find(".layui-table-body tr:not([data-level])").attr("data-level", t),
            ...
            if (layui.each(e.find('td[data-field="' + y + '"]'), function (e, t) {
                var a, n, i = (t = A(t)).closest("tr"), t = t.children(".layui-table-cell");
                t.hasClass("layui-table-tree-item") || (n = i.attr("lay-data-index")) && (i = d.find('tr[lay-data-index="' + n + '"]'),
                    ...
                    t.html(['<div class="layui-inline layui-table-tree-flexIcon" ', 'style="', "margin-left: " + p * i.attr("data-level") + "px;", a[u] || o.showFlexIconIfNotParent ? "" : " visibility: hidden;", '">', a[H] ? o.flexIconOpen : o.flexIconClose, "</div>", o.showIcon ? '<div class="layui-inline layui-table-tree-nodeIcon' + (a[c.icon] || o.icon ? " layui-table-tree-iconCustom" : "") + (a[u] ? "" : " layui-table-tree-iconLeaf") + '">' + (l.normalizedIcon(a[c.icon]) || o.icon || (a[u] ? a[H] ? o.iconOpen : o.iconClose : o.iconLeaf) || "") + "</div>" : "", n].join("")).find(".layui-table-tree-flexIcon").on("click", function (e) {
                        layui.stope(e),
                            J({
                                trElem: i
                            }, null, null, null, !0)
        ...
        function (a) {
            ...
            layui.each(a.treeToFlat(P.cache[e.id]), function (e, t) {
                t.LAY_HIDE || (a.getNodeDataByIndex(t[z]).LAY_NUM = ++n,
        ...
        var t = this;
        t.tableIns = P["reloadData" === e ? "reloadData" : "reload"](t.tableIns.config.id, A.extend(!0, {}, t.config)),
        ...
        var n = this.getOptions()
            , i = n.tree;
        return e = e || P.cache[n.id],
            N(e, t, i.customName.children, a)
    }
        ,
        ...
        B.updateStatus = function (e, t, a) {
            var e = j(e)
                , n = e.getOptions();
            return a = a || (n.url ? P.cache[n.id] : n.data),
                e.updateStatus(a, t)
        }
        ,
        B.sort = function (e) {
            var t, a, i, l, n, d = j(e);
            d && (n = (t = d.getOptions()).tree,
                a = B.getData(e),
                ...
                ,
                t.autoSort) && ((n = t.initSort).type ? l(a, n.field, "desc" === n.type) : l(a, P.config.indexName, null),
                    P.cache[e] = a,
                    d.initData(a),
                    B.renderData(e))
        }
        ...
        function (n) {
            ...
            n.update = function () {
                var e = arguments
                    , t = (A.extend(i.getNodeDataByIndex(l), e[0]),
                        d.apply(this, e))
        ...
        B.removeNode = function (e, t, a) {
            var n = j(e);
            if (n) {
                var i, l = n.getOptions(), d = l.tree, r = d.customName.isParent, o = d.customName.children, c = l.elem.next(), u = [], s = P.cache[e], t = n.getNodeDataByIndex("string" === layui.type(t) ? t : t[z], !1, "delete"), f = n.getNodeDataByIndex(t[p]), d = (n.updateCheckStatus(f),
                    n.treeToFlat([t], t[d.customName.pid], t[p])), t = (layui.each(d, function (e, t) {
                        t = t[z];
                        u.push('tr[lay-data-index="' + t + '"]'),
                            -1 !== t.indexOf("-") && delete s[t]
                    }),
                        c.find(u.join(",")).remove(),
                        n.initData());
                for (i in s)
                    -1 !== i.indexOf("-") && i !== s[i][z] && delete s[i];
                layui.each(n.treeToFlat(t), function (e, t) {
                    t[m] && t[m] !== t[z] && c.find('tr[lay-data-index="' + t[m] + '"]').attr({
                        "data-index": t[z],
                        "lay-data-index": t[z]
                    }).data("index", t[z])
                }),
                    ...
                    l.hasNumberCol && v(n),
                    f && (d = c.find('tr[lay-data-index="' + f[z] + '"]'),
        ...
        B.addNodes = function (e, t) {
            ...
            if (a) {
                ...
                if (u) {
                    ...
                    if (P.cache[e] = P.cache[e].concat(c, p),
                        n.url || (n.page ? (y = n.page,
                            n.data.splice.apply(n.data, [y.limit * (y.curr - 1), y.limit].concat(P.cache[e]))) : n.data = P.cache[e]),
                        a.initData(),
                        l.find(".layui-none").length)
                        return P.renderData(e),
                            c;
                    var x, f = P.getTrHtml(e, c), h = {
                        trs: A(f.trs.join("")),
                        ...
                        parseInt(c[0][z]) - 1), y = l.find(q), n = l.find(R), f = l.find(Y);
                    -1 == r ? y.find('tr[data-level="0"][data-index="0"]')[0] ? (y.find('tr[data-level="0"][data-index="0"]').before(h.trs),
                        n.find('tr[data-level="0"][data-index="0"]').before(h.trs_fixed),
                        f.find('tr[data-level="0"][data-index="0"]').before(h.trs_fixed_r)) : (y.find("tbody").prepend(h.trs),
                            n.find("tbody").prepend(h.trs_fixed),
                            f.find("tbody").prepend(h.trs_fixed_r)) : -1 === o ? (y.find("tbody").append(h.trs),
                ...
                return a.updateCheckStatus(u),
                    u && (o = l.find('tr[lay-data-index="' + u[z] + '"]'),
                        a.updateNodeIcon({
                            scopeEl: o,
                            isExpand: u[H],
                            isParent: u[s]
                    ...
                    B.resize(e),
                    t && l.find(q).find('tr[lay-data-index="' + c[0][z] + '"]').get(0).scrollIntoViewIfNeeded(),
                    c
            }
        }
        ,
        ...
        a.prototype.updateCheckStatus = function (e, t) {
            ...
            return !!u.hasChecboxCol && (a = u.tree,
                ...
                o = !(r = !0),
                0 < (e = (e = "all" === a.data.cascade ? P.cache[n] : B.getData(n, !0)).filter(function (e) {
        ...
        a.prototype.updateParentCheckStatus = function (a, n) {
            var i, e = this.getOptions(), t = e.tree, e = e.id, l = P.config.checkName, t = t.customName.children, d = [];
        ...
        function (e, t, a) {
            ...
            if (a) {
                ...
                var c, a = n.getNodeDataByIndex(e.attr("data-index")), u = P.config.checkName;
                if (!i)
                    return t = "boolean" === layui.type(t) ? t : !a[u],
                        i = n.updateStatus(a ? [a] : P.cache[d], function (e) {
                            e[P.config.disabledName] || (e[u] = t,
                                e[b] = !1)
                ...
                a && (n.updateStatus(null, function (e) {
                    var t;
                    e[u] && (t = r.find('tr[lay-data-index="' + e[z] + '"] input[type="radio"][lay-type="layTableRadio"]'),
                        e[u] = !1,
    ...
    B.on("checkbox", function (e) {
        ...
        B.setRowChecked = function (a, e) {
            ...
            c && (t = c.getOptions().elem.next(),
                ...
                r = c.getNodeDataByIndex(i)) && (l = function (e) {
                    o.push(e),
                        t.find('tr[lay-data-index="' + e + '"]').length || (e = c.getNodeDataByIndex(e)[p]) && l(e)
                }
                    ,
                    (d = t.find('tr[lay-data-index="' + i + '"]')).length || (r = r[p],
                        o = [],
                        l(r),
        ...
        B.reloadAsyncNode = function (a, e) {
            var t, n, i = j(a);
            i && (t = i.getOptions().tree)["async"] && t["async"].enable && (n = i.getNodeDataByIndex(e)) && (n[X] = !1,
                n[H] = !1,
                n[V] = !1,
        ...
        B.getNodesByFilter = function (e, t, a) {
            ...
            if (d)
                return i = d.getOptions(),
                    ...
                    l = [],
                    layui.each(i, function (e, t) {
                        if (l.push(d.getNodeByIndex(t[z])),
                            n)
                            return !0
                    }),
                    l
...
layui.define(["jquery", "lay"], function (e) {
    ...
    var o = layui.$
            ...
            layui.device(),
        {
            ...
            set: function (e) {
                var n = this;
                return n.config = o.extend({}, n.config, e),
                    n
            },
            on: function (e, n) {
        ...
        , n = function (e) {
            var n = this;
            n.config = o.extend({}, n.config, t.config, e),
                n.render()
        };
    n.prototype.config = {
        width: "600px",
        ...
        n.prototype.render = function () {
            ...
            o.extend(n, l.options(i[0])),
                n.elem = o(n.elem),
                n.elem[0] && (e.elemItem = n.elem.find(">*[carousel-item]>*"),
                    n.index < 0 && (n.index = 0),
        ...
        n.prototype.autoplay = function () {
            var e = this
                , n = e.config
                , i = e.elemItem.length;
            n.autoplay && (clearInterval(e.timer),
                1 < i) && (e.timer = setInterval(function () {
                    e.slide()
                }, n.interval))
        }
        ,
        ...
        n.prototype.indicator = function () {
            var n, e = this, i = e.config, t = e.elemItem.length, a = e.elemInd = o(['<div class="' + d + '"><ul>', (n = [],
        ...
        n.prototype.slide = function (e, n) {
            ...
            i.haveSlide || a <= 1 || ("sub" === e ? (i.subIndex(n),
                t.eq(o.index).addClass(m),
                setTimeout(function () {
                    t.eq(l).addClass(c),
                        t.eq(o.index).addClass(c)
                }, 50)) : (i.addIndex(n),
...
layui.define("jquery", function (o) {
    ...
    l.prototype.load = function (o) {
        var i, n, r, l, c, m, e, t, a, f, s, u, p, d, y, h = this, g = 0, v = w((o = o || {}).elem);
        if (v[0])
            return c = w(o.scrollElem || document),
                m = "mb" in o ? o.mb : 50,
                ...
                d = function (o, l) {
                    ...
                    o = w(o),
                        ...
                        i = null,
                        r && r(),
                        f && (o = s ? c.prop("scrollHeight") : document.documentElement.scrollHeight,
                            1 === g ? c.scrollTop(o) : 1 < g && c.scrollTop(t + (o - e)))
                }
                ,
                (y = function () {
                    i = !0,
                        p.find("a").html('<i class="layui-anim layui-anim-rotate layui-anim-loop layui-icon ">&#xe63e;</i>'),
                        "function" == typeof o.done && o.done(++g, d)
                }
                )(),
                ...
                e && c.on("scroll.flow", function () {
                    var e = w(this)
                        , t = e.scrollTop();
                    l && clearTimeout(l),
                        !n && v.width() && (l = setTimeout(function () {
        ...
        l.prototype.lazyimg = function (o) {
            var l, m = this, a = 0, f = w((o = o || {}).scrollElem || document), s = o.elem || "img", n = "top" === (o.direction || "bottom"), u = o.scrollElem && o.scrollElem !== document, p = function (l, o) {
                var e, t = f.scrollTop(), o = t + o, i = u ? l.offset().top - f.offset().top + t : l.offset().top;
                (n ? i + l.height() : i) >= t && i <= o && l.attr("lay-src") && (e = l.attr("lay-src"),
                    layui.img(e, function () {
                        var o = m.lazyimg.elem.eq(a);
                        l.attr("src", e).removeAttr("lay-src"),
                            o[0] && r(o),
                            a++
                    }, function () {
                        m.lazyimg.elem.eq(a);
