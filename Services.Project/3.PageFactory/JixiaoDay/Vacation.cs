            ...
            public class ZbVacationPost
            {
                ...
                public ModelBasic.EmtButtonGroup GetButtonGroup(DtoReq req = null)
                {
                    ...
                    buttonGroup.buttonItems.Add(new ModelBasic.EmtModel.ButtonItem("")
                    {
                        ...
                        eventOpenLayer = new ModelBasic.EmtModel.ButtonItem.EventOpenLayer
                        {
                            url = "/userinfo/vacation/vacationlist",
                        }
                    });
                    return buttonGroup;
                }
                ...
                {
                    List<string> lSql = new List<string>();
                    var dtoReqData = req.data_json.ToModel<ModelDb.p_jixiao_vacation>();
                    var result = new JsonResultAction();
                    ...
                    lSql.Add(new ModelDb.p_jixiao_vacation
                    {
                        ...
                        tg_user_sn = new DomainUserBasic.UserRelationApp().GetParentUserSn(ModelEnum.UserRelationTypeEnum.厅管邀主播, new UserIdentityBag().user_sn),
                        zb_user_sn = new UserIdentityBag().user_sn,
                        new_zb_user_sn = dtoReqData.new_zb_user_sn,
                        note = dtoReqData.note
                    }.InsertOrUpdateTran());
