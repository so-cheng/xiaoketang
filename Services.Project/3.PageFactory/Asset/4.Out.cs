        ...
        public partial class Asset
        {
            ...
            public class AssetOutList
            {
                ...
                public CtlListFilter GetListFilter(DtoReq req)
                {
                    ...
                    listFilter.formItems.Add(new EmtHidden("id")
                    {
                        placeholder = "资产类别",
                    });
                    ...
                    listFilter.formItems.Add(new EmtSelect("op_type")
                    {
                        placeholder = "请选择操作类型",
                        width = "140",
                        options = UtilityStatic.CommonHelper.EnumToDictionary<ModelDb.asset_out.op_type_enum>()
                    });
                    return listFilter;
                }
                /// <summary>
                ...
                public CtlListDisplay GetListDisplay(DtoReq req = null)
                {
                    ...
                    listDisplay.listItems.Add(new EmtModel.ListItem("num_text")
                    {
                        text = "出库数量",
                        width = "100",
                        minWidth = "100",
                ...
                public ModelResult.List GetListData(CtlListDisplay.ListData.Req reqJson)
                {
                    ...
                    if (!req["op_type"].ToNullableString().IsNullOrEmpty()) where += $" AND (op_type like '%{req["op_type"]}%')";
                    //name查询条件
                ...
                public class ItemDataModel : ModelDb.asset_out
                {
                    public string op_type_text
                    {
                        get
                        {
                            return op_type.ToEnum<ModelDb.asset_out.op_type_enum>();
                        }
                    }
            ...
            /// 出库明细
            /// </summary>
            public class AssetOutDetailList
            {
                #region DefaultView
                /// <summary>
                /// 获取页面数据模型
                ...
                {
                    var listFilter = new CtlListFilter();
                    listFilter.formItems.Add(new EmtHidden("category_id")
                    {
                        placeholder = "资产类别",
                        defaultValue = req.category_id
                    });
                    listFilter.formItems.Add(new EmtHidden("out_sn")
                    {
                        placeholder = "出库编号",
                    ...
                    listFilter.formItems.Add(new EmtSelect("status")
                    {
                        ...
                        width = "100",
                        //defaultValue = ""
                        options = UtilityStatic.CommonHelper.EnumToDictionary<ModelDb.asset_out_item.status_enum>()
                    });
                    return listFilter;
                }
                ...
                public CtlListDisplay GetListDisplay(DtoReq req = null)
                {
                    ...
                    listDisplay.listItems.Add(new EmtModel.ListItem("out_time")
                    {
                        text = "实际出库时间",
                        width = "180",
                        minWidth = "180",
                ...
                public ModelResult.List GetListData(CtlListDisplay.ListData.Req reqJson)
                {
                    ...
                    var dateRange = UtilityStatic.CommonHelper.DateTimeRangeFormat(req["create_time"].ToString(), 0);
                    if (!req["name"].ToNullableString().IsNullOrEmpty()) where += $" AND (name like '%{req["name"]}%')";
                    if (!req["out_sn"].ToNullableString().IsNullOrEmpty()) where += $" AND (out_sn ='{req["out_sn"]}')";
                ...
                public class ItemDataModel : ModelDb.asset_out_item
                {
                    ...
                    public string status_text
                    {
                        get
                        {
                            return status.ToEnum<ModelDb.asset_out_item.status_enum>();
                        }
                    }
            ...
            /// 出库批量审核
            /// </summary>
            public class AssetOutChecksPost
            {
                #region DefaultView
