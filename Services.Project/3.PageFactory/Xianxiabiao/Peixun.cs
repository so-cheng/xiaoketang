        ...
        public class Xianxiabiao
        {
            ...
            public class PeixunPost
            {
                ...
                private ModelBasic.CtlFormDisplay GetFormDisplay(ModelBasic.PagePost pageModel, DtoReq req)
                {
                    ...
                    //formDisplay.formItems.Add(new ModelBasic.EmtInputNumber("in_group_3")
                    //{
                    //    title = "第三天在群人数",
                    //    placeholder = "",
                    //    defaultValue = p_mengxin.in_group_3.ToString(),
                    //    colLength = 6
                    //});
                    ...
                    formDisplay.formItems.Add(new ModelBasic.EmtInputNumber("first_employ")
                    {
                        title = "首次推出人数",
                        placeholder = "",
                        defaultValue = p_mengxin.first_employ.ToString(),
                        colLength = 6
                    });
                    formDisplay.formItems.Add(new ModelBasic.EmtInputNumber("resit_num")
                    {
                        title = "补考人数",
                        placeholder = "",
                        defaultValue = p_mengxin.resit_num.ToString(),
                        colLength = 6
                    });
                    formDisplay.formItems.Add(new ModelBasic.EmtFieldset("")
                    {
