    ...
    public partial class ServiceFactory
    {
        public partial class UserInfo
        {
            public class Zt
            {
                ...
                {
                    var ztInfo = DoMySql.FindEntity<ModelDb.user_base>($"id='{id}' and user_type_id='{new DomainBasic.UserTypeApp().GetInfoByCode("jder").id}'", false).ToModel<ZtInfo>();
                ...
                private string GetZtBaseInfosForWhere(ZtBaseInfoFilter ztBaseInfoFilter)
                {
                    ...
                    {
                        case ZtBaseInfoFilter.AttachUserType.UserType.基地:
