...
namespace WebProject.Areas.QianYue.Controllers
{
    ...
    public class CommissionController : BaseLoginController
    {
        ...
        {
            var req = new PageFactory.QianYue.SituationView.DtoReq();
            var pageModel = new PageFactory.QianYue.SituationView().Get(req);
        ...
        {
            var req = new PageFactory.QianYue.Confirmed.DtoReq();
            var pageModel = new PageFactory.QianYue.Confirmed().Get(req);
            return View(pageModel);
        }
        ...
        {
            var req = new PageFactory.QianYue.UnConfirm.DtoReq();
            var pageModel = new PageFactory.QianYue.UnConfirm().Get(req);
            return View(pageModel);
        }
