...
namespace WebProject.Areas.Jixiao.Controllers
{
    ...
    public class TingZhanController : BaseLoginController
    {
        ...
        public ActionResult TingZhanList(PageFactory.TingZhanList.DtoReq req)
        {
            ...
            pageModel.listDisplay.listData.attachFilterSql = $"user_sn in {new DomainBasic.UserApp().GetUserSnsByOrganizeIdForSql(new DomainBasic.UserApp().GetInfoById(new UserIdentityBag().id).organize_id.ToInt())}";
